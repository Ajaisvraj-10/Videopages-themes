  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 text-center">
        <div class="mt-0" style="position:relative;width:320px;height:680px" v-if="themename=='c1'">
...
<script>
import SignInPage from '/src/views/app/c1/sign-in'
import HomePage from '/src/views/app/c1/home'
import PlanPage from '/src/views/app/c1/plan'
import VideosPage from '/src/views/app/c1/movies'
import WatchingPage from '/src/views/app/c1/video'
export default {
  components: {
    SignInPage,
    HomePage,
