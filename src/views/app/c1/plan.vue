...
<template>
  <div class="main-content capcee-plan">
    ...
    <div class="site-wrapper plan-wrapper"> 
      <div class="search-header m-0 w-100 flex-align" style="background: #353a40;">
            <div class="w-100 flex-align3 g3">
              ...
              <h5 class="text-white font-weight-400 text-18 mb-0 ml-2">plan</h5>
            </div>
        ...
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-12 plan-card-col" style="display: flex;width: 100%;gap: 20px;overflow: auto;">
              <div class="plans-card mb-3" v-for="plan in plans"  @click="current_plan=plan" :class="plan.id==current_plan.id?'active_plan':''">
                ...
                <div class="rounded2-bottom px-2 pb-4 pt-1  text-center text-white text-14 font-weight-500" >
        ...
        <div class="plan-sec2 px-3 mt-5" v-if="crnt_tab=='payment_methods'">
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <button class="btn btn-primary rounded2 py-3 w-100 my-2" v-for="payment_method in payment_methods" @click="setRazorpay(payment_method);crnt_tab='pay'">{{payment_method.name}}</button>
        ...
        <div class="plan-sec2 px-3 mt-5" v-if="crnt_tab=='pay'">
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <button class="purchase-button"  @click="purchasePlan()" v-if="razorpay_options.key">Pay Now</button>
...
.plans-card.active_plan{
  border:2px solid #ffc107;
}

.plan-header {
    background-image:linear-gradient(rgb(0 0 0 / 12%), rgb(7 12 15)), url(/all-images/bg1.jpg);
    min-height: 120px;
...
.capcee-plan:before{
  ...
  width:100%;
  height:100%;
  background: url(/all-images/bg3.jpg);
  opacity:.2;
