...
<template>
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper signin-wrapper"> 
       
        <div class="search-header w-100 flex-align" style="background: #353a40;">
            <div class="w-100 flex-align3 g3">
              ...
              <h5 class="text-white font-weight-400 text-18 mb-0 ml-2">Sign in</h5>
            </div>
              <div class="login-tab" @click="crnt_tab='login'"  v-if="crnt_tab=='register'">Login</div>
              <div class="login-tab" @click="crnt_tab='register'" v-if="crnt_tab=='login'">Register</div>
        </div>
...
.capcee-login:before{
  ...
  width:100%;
  height:100%;
  background: url(/all-images/bg2.jpg);
  filter: blur(10px);
