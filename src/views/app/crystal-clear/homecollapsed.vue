<!-- <template>
  ...
  <path d="M28 26.6663C28 27.4027 27.4031 27.9996 26.6667 27.9996H5.33333C4.59696 27.9996 4 27.4027 4 26.6663V12.6517C4 12.2403 4.18996 11.8519 4.51475 11.5993L15.1815 3.30299C15.6629 2.92851 16.3371 2.92851 16.8185 3.30299L27.4852 11.5993C27.81 11.8519 28 12.2403 28 12.6517V26.6663ZM14.6667 17.3329V25.3329H17.3333V17.3329H14.6667Z" fill="#00925D"/>
</svg></div>
  ...
  <path d="M13.1716 11.9993L8.2218 7.0496L9.636 5.6354L16 11.9993L9.636 18.3633L8.2218 16.9491L13.1716 11.9993Z" fill="black"/>
</svg>
                </div>
              </div>
        </div>
            ...
            <div class="movie_card">
              ...
              <div class="movie_title_container">
                ...
                <div class="rating_section">
                  <div>
                    <svg class="star" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M12.0008 17L6.12295 20.5902L7.72105 13.8906L2
     .49023 9.40983L9.35577 8.85942L12.0008 2.5L14.6458 8.85942L21.5114 9.40983L16.2806 13.8906L17.8787 20.5902L12.0008 17Z" fill="#F8B70F"/>
  </svg>
                  </div>
                  <div class="rating">4.8</div>
                </div>
