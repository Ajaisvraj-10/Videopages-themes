          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-12 plan-card-col pt-3" style="display: flex;width: 100%;gap: 20px;overflow: auto;">
              <div class="plans-card mb-3" v-for="plan in plans" :style="plan.id==current_plan.id?'background: #673ab714; border-radius:6px;':'border-radius:6px;'" @click="current_plan=plan">
                <div class="p-3 rounded2-top position-relative" :style="plan.id==current_plan.id?'background: #673ab714; border-radius:6px 6px 0 0;':'border-radius:6px 6px 0 0;'" @click="current_plan=plan">
                ...
                <div class="rounded2-bottom px-3 py-2 text-center text-white  text-14 font-weight-500" >
                  <div class="text-12">
                    {{plan.description}}
                  </div>
                  <div class="text-12 mt-2">
                         <!-- <sup class="text-white ">₹999</sup> --><span class="text-white text-20 font-weight-600 ">{{plan.currency_symbol}}{{plan.price}}</span>
                  </div>
                </div>
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                <img src="/vid_theme_apk/images/apple.svg" style="width:40px;">
                <img src="/vid_theme_apk/images/google.svg" style="width:40px;">
                <img src="/vid_theme_apk/images/fb.svg" style="width:40px;">
                <img src="/vid_theme_apk/images/twitter.svg" style="width:40px;">
              </div>
