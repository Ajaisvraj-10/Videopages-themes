  ...
  <div class="main-content" >
    ...
    <div class="site-wrapper"> 
        ...
        <div class="categories-container menu-wrapper">
            <div class="row m-3 pl-5">
                <div class="col-md-3 p-2" v-for="(category,key) in categories">
                    <router-link :to="'/filter/category/'+slugify(category.name)" class="categorie-card focus-img2" :style="'background: '+setBgColor(key)+';'">
                        <div>
                            <h6>{{category.name}}</h6>
                        </div>
                    </router-link>
