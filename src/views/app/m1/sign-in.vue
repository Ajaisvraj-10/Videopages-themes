        ...
        <div class="login-am" v-if="crnt_tab=='login'">
            <div id="signInBorder" class="signin-2">
              ...
              <div class="google-login">
                <button class="google-login-child foucs-btn">
                  <img src="/all-images/google.png"> Sign Up with Google
                </button>
                <button class="google-login-child foucs-btn">
                  <img src="/all-images/apple-white.png" style="filter:invert(100%);"> Sign Up with Apple ID
                </button>
              </div>
              ...
              <form ref="loginUser" @submit.prevent="loginUser()">
                ...
                <div class="text-right mb-4">
                   ...
                   <a style="color: lightgray;">Forgot your password?</a>
                  
                </div>
                <div>
                  <button type="submit" id="capcee" class="btn-light">Login</button>
                </div>
              </form>
             
              <div class="text-center my-3">
                <span class="text-12  mx-1 login-opt" style="color:lightgray;">New to capcee?</span>
                <a class="text-12 cursor-pointer mx-1 login-opt font-weight-600" style="color: white;" @click="crnt_tab='register'">Register</a>
        ...
        <div class="signin-am" v-if="crnt_tab=='register'">
            <div id="signInBorder" class="signin-2">
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <div>
                    <button id="capcee" class="btn-light" type="submit">Register</button>
                </div>
              </form>
  ...
  methods: {
    ...
    loginUser(new_user=false) {
      ...
      if(this.$route.query.device_token){
        formdata.append('device_token',this.$route.query.device_token)
      }
      var headers = new Headers();
      headers.append("Authorization", "Bearer "+this.$root.admin_token);
      fetch(this.api_url+'/users/login_and_register/', {
          method : 'put',
          headers: headers,
          body : formdata
      })
      ...
      .then((jsonData) => {
        if(jsonData.access){
          this.showAlert('Logged successfully!')
        }else{
