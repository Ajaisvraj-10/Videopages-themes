                ...
                <b-tab  active>
                    ...
                    <div class="profile-tab" >
                        ...
                        <div class="account-tabs">
                          ...
                          <button class="account-tab" v-b-modal.delete-account>
                            <h5>Delete Account</h5>
                            <img src="/m1/images/stream_right_arrow.png">
                          </button>
                          <router-link to="login" class="account-tab">
                            <h5>Log out</h5>
                            <img src="/m1/images/stream_right_arrow.png">
                          </router-link>
                    </div>
                    ...
                    <div class="profile-tab" >
                        ...
                        <div class="account-tabs">
                          <div class="account-tab" @click="show_img=!show_img">
                            <h5>Subtitles</h5>
                            <img src="/m1/images/toggle.png" width="35" v-if="show_img">
                            <img src="/m1/images/off-toggle.png" width="35" v-else>
                          </div>
