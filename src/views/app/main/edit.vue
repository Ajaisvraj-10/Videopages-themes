  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        ...
        <div class="mt-0" style="position:relative" v-if="themename=='amazone'">
          <HomePageAmazone edit="1" :blocks="blocks" class="combonent_class" v-if="current_page.slug=='/'" @selectedContent="selectedContent"></HomePageAmazone>
          <SignInPageAmazone edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/sign-in'" @selectedContent="selectedContent"></SignInPageAmazone>
          <PlanPageAmazone edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/plan'" @selectedContent="selectedContent"></PlanPageAmazone>
          <MainPageAmazone edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/main'" @selectedContent="selectedContent"></MainPageAmazone>
          <WatchingPageAmazone edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/watching'" @selectedContent="selectedContent"></WatchingPageAmazone>
        </div>
      </div>
...
import SignInPageAmazone from '/src/views/app/videozone_web/sign-in'
import HomePageAmazone from '/src/views/app/videozone_web/home'
import PlanPageAmazone from '/src/views/app/videozone_web/plan'
import MainPageAmazone from '/src/views/app/videozone_web/main'
import WatchingPageAmazone from '/src/views/app/videozone_web/video'
export default {
  components: {
    SignInPageAmazone,
    HomePageAmazone,
