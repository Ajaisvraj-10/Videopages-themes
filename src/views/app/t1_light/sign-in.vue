  ...
  <div class="main-content capcee-login">
    <div class="site-wrapper" v-if="start"> 
        <div class="flex-align w-100 p-3 ">
          <img src="/all-images/logo-dark.png" style="max-width:120px;max-height:60px;">
          <router-link :to="edit?'':{name:'home'}">
            <img src="/all-images/close-dark.png" style="width:15px;opacity:.5;">
          </router-link>
        </div>
        <div class="login-am" v-if="crnt_tab=='login'">
            <div id="signInBorder" class="signin-2">
              ...
              <div class="google-login">
                ...
                <div class="google-login-child">
                  <img src="/all-images/apple-dark.png"> Sign Up with Apple ID
                </div>
              </div>
              ...
              <form ref="loginUser" @submit.prevent="loginUser()">
                ...
                <div class="text-right mb-4">
                    ...
                    <span><a  style="color: #262626;">Forgot your password?</a></span>
              ...
              <div class="text-center my-3">
                <span class="text-12  mx-1 login-opt" style="color:#262626;">New to capcee?</span>
                <span class="text-12 cursor-pointer mx-1 login-opt font-weight-600" style="color: dark;" @click="crnt_tab='register'">Register</span>

                
              </div>

                <!--<div class="d-flex justify-content-center my-4" style="gap:20px;">
                  <h6 class="text-10 text-dark font-weight-600" style="width: 35px;
                    height: 35px;
                    border-radius: 50%;
                    display: flex;
                    align-items: center;
        ...
        <!--<div class="otp-am" v-if="crnt_tab=='otp'">
            ...
            <div id="signInBorder" class="signin-2">
                <div class="mb-3">
                  ...
                  <h6 class="text-dark fontweight-360  text-13 login-opt">
            ...
            <div id="signInBorder" class="signin-2">
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <!--<div class="text-right  mt-1 mb-4">
                    <span class="text-10 login-opt" style="color:#262626;">By proceeding you agree to our <a  style="color: #fff;font-weight-500">Terms of service & privacy policy </a></span>
                </div>-->
                <div>
              ...
              <div class="text-center my-3">
                <span class="text-12 text-dark mx-1 login-opt" style="color:#262626;">Already registered?</span>
                <span class="text-12 cursor-pointer mx-1 font-weight-600 login-opt" style="color: #000;" @click="crnt_tab='login'">Login</span>
