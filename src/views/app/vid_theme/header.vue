        ...
        <header class="header-holder-2" v-if="is_start">             
            <div class="menu-wrapper  d-flex align-items-center justify-content-between"> 
                <div class="flex-align3">         
                    ...
                    <div class="menu-home" >
                        <!-- <ul class="home-nav" >
                            <router-link v-for="header in site_header" :to="edit?'':header.link" v-if="header.status">
                            ...
                            <div class="min-650 d-flex-in-header" v-if="$root.token">
                                <router-link :to="edit?'':{name:'profile'}">
                                    <button class="btn login-btn mr-2" style="background-color: initial;color: white;font-size: 13px;font-weight: 500;border: 1px solid rgb(130, 48, 198);border-radius: 5px;height: 35px;align-items: center;display: flex;"><img src="/all-images/account.png" style="width:20px;" class="mr-1 buy-plan-img"> Profile</button>
                                </router-link>
                                <router-link :to="edit?'':{name:'plan'}">
                                    <button class="btn" style="background:linear-gradient(45deg, #8230c6, #7d208e);color: white;font-size: 13px;font-weight: 500;border: 1px solid #8230c6;border-radius: 5px;display:flex; align-items:center;"><img src="/all-images/up-arrow.png" style="width:20px;" class="mr-1 buy-plan-img">UPGRADE PLAN</button>
                                </router-link>
                            </div>
                            <div class="min-650 d-flex-in-header" v-else>
                                <router-link :to="edit?'':{name:'sign-in'}">
                                    <button class="btn login-btn mr-2" style="background-color: initial;color: white;font-size: 13px;font-weight: 500;border: 1px solid rgb(130, 48, 198);border-radius: 5px;">LOGIN</button>
                                </router-link>
                                <router-link :to="edit?'':{name:'plan'}">
                ...
                <!-- <div class="text-center header-right flex-align3" style="gap:8px;">
                    ...
                    <div class="d-flex-in-header" v-else>
                        <router-link :to="edit?'':{name:'sign-in'}">
                            <button class="btn login-btn mr-2" style="background-color: initial;color: white;font-size: 13px;font-weight: 500;border:1px solid rgb(130, 48, 198);border-radius: 5px;height: 35px;">LOGIN</button>
                        </router-link>
                        <router-link :to="edit?'':{name:'plan'}">
