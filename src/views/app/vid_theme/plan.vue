        ...
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-5 plan-card-col plan-prize-card pt-3" style="display: flex;width: 100%;overflow: auto;flex-direction: column;align-items: center;">
              <div class="plans-card mb-3" v-for="plan in plans" :style="plan.id==current_plan.id?'background: #673ab714; border-radius:6px;':'border-radius:6px;'" @click="current_plan=plan">
                <div class="p-3 rounded2-top position-relative" :style="plan.id==current_plan.id?'background: #673ab714; border-radius:6px 6px 0 0;':'border-radius:6px 6px 0 0;padding-bottom:0!important;'" @click="current_plan=plan">
        ...
        <div class="plan-sec2 px-3" v-if="crnt_tab=='payment_methods'">
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <button class="btn btn-primary rounded2 py-2 w-100 my-2" v-for="payment_method in payment_methods" @click="setRazorpay(payment_method);crnt_tab='pay'">Select</button>
