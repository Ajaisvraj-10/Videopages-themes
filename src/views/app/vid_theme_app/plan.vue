        ...
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-12 plan-card-col" style="display: flex;width: 100%;gap: 20px;overflow: auto;">
              <div class="plans-card mb-3" v-for="plan in plans" :style="plan.id==current_plan.id?'background: #673ab714; border-radius:6px;':'background: black;border-radius:6px;'" @click="current_plan=plan">
...
export default {
  ...
  methods: {
    ...
    setStripe(){
      this.crnt_tab='pay'
      this.$router.push('/plan?selected_plan='+this.current_plan.id)
    },
    purchasePlan(e){
...
.plan-header {
    background-image:linear-gradient(rgb(0 0 0 / 12%), rgb(20 8 32)), url(/crystal-clear/images/bg1.jpg);
    min-height: 50px;
