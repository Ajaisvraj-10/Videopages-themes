            ...
            <div v-if="current_movie.id && start">
                ...
                <div class="flex-align plan-banner" v-if="!frontent_settings.have_plan">
                    ...
                    <router-link :to="edit?'':{name:'plan'}">
                        <button class="btn" style="background-color: #673ab7;color: white;font-size: 13px;font-weight: 500;border: 1px solid #673ab7;border-radius: 5px;padding:8px 10px;width: max-content;">
                        BUY PLAN</button>
                    </router-link>
                                ...
                                <template #img>
                                    <div class="image-row">
                                        ...
                                        <div class="hover-modal image" v-for="movie in sort_movie" @click="current_movie=movie">
                                            <router-link :to="edit?'':{name:'video',params: { type: slugify(movie.type), category: slugify(movie.category_detail.name), slug: movie.slug }, query: {language:movie.language_detail.name, video_slug:movie.slug}}">
                                            <div class="position-relative" >
...
<script>
import MainHeader from '/src/views/app/vid_theme_app/header'
export default {
