    ...
    <div class="site-wrapper"> 
      ...
      <div class="plan-container">
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          <h6 class="text-white text-18 font-weight-500 text-center mb-5 pb-3">Choose your premium plan</h6>
          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-12 plan-card-col" style="display: flex;width: 100%;gap: 20px;overflow: auto;">
              <div class="plans-card mb-3" v-for="plan in plans">
                <div class="p-3 rounded2-top position-relative" :style="plan.id==current_plan.id?'background: #673ab714; border-radius:6px 6px 0 0;':'background: black;border-bottom:1px solid lightgray;border-radius:6px 6px 0 0;'" @click="current_plan=plan">
                ...
                <div class=" px-3 py-2 text-center text-white bg-dark text-14 font-weight-500" style="border-radius:0 0 6px 6px;">
                  <h6 class="text-12 text-white mb-2">
                    {{plan.description}}
                  </h6>
                  <h6 class="text-12">
...
.plan-header {
    background-image:linear-gradient(rgb(0 0 0 / 12%), rgb(20 8 32)), url(/vid_theme_mobile/images/bg1.jpg);
    min-height: 150px;
