    ...
    <div class="site-wrapper"> 
      ...
      <div class="plan-container">
        <!--<div class="plan-banners mb-4">
          <img src="/video_live_app/images/bg1.jpg">
        </div>-->
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                <img src="/video_live_app/images/apple.svg" style="width:40px;">
                <img src="/video_live_app/images/google.svg" style="width:40px;">
                <img src="/video_live_app/images/fb.svg" style="width:40px;">
                <img src="/video_live_app/images/twitter.svg" style="width:40px;">
              </div>
...
.plan-header {
    background-image:linear-gradient(rgb(0 0 0 / 12%), rgb(20 8 32)), url(/video_live_app/images/bg1.jpg);
    min-height: 80px;
