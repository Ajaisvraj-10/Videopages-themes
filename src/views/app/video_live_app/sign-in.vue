...
<template>
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper"> 
        ...
        <img src="/video_live_app/images/logo.png" style="max-width:200px;max-height:60px;">
            ...
            <div id="signInBorder" class="signin-2 mt-4">
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <div class="text-center  my-3">
                    ...
                    <span class="text-13 text-white">By proceeding you agree to our <a  style="color: lightgray;">Terms of service & privacy policy </a></span>
