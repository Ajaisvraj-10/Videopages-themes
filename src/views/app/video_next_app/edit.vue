  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 text-center">
        <div class="mt-0" style="position:relative;width:320px;height:680px" v-if="themename=='video_next_app'">
...
<script>
import SignInPage from '/src/views/app/video_next_app/sign-in'
import HomePage from '/src/views/app/video_next_app/home'
import PlanPage from '/src/views/app/video_next_app/plan'
import VideosPage from '/src/views/app/video_next_app/movies'
import WatchingPage from '/src/views/app/video_next_app/video'
export default {
  components: {
    SignInPage,
    HomePage,
