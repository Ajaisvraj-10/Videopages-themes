    ...
    <div class="site-wrapper"> 
      ...
      <div class="plan-container">
        <div class="plan-sec " v-if="crnt_tab=='plans'">
          <h6 class="text-white text-14 font-weight-500 text-center mb-4">Anytime Big Entertainment</h6>
          <h6 class="text-white text-11 font-weight-400 mb-2 px-3">Step 1 of 3</h6>
          <h6 class="text-white text-14 font-weight-500 mb-4 px-3">Subscribe to {{current_plan.name}}</h6>
          <div class="plan-card row mx-0" >
            ...
            <div class="col-md-6 plan-card-col">
              <div class="mb-3" v-for="plan in plans">
                <div class="p-3 rounded2-top" :style="plan.id==current_plan.id?'background: linear-gradient(45deg, #e2e27f, #f5f5f5b8); border: 1px dashed #e91e6340;border-radius:6px 6px 0 0;':'background: rgb(237 237 237);border-radius:6px 6px 0 0;'" @click="current_plan=plan">
        ...
        <div class="plan-sec2  mt-4" v-if="crnt_tab=='payment_methods'">
          <h6 class="text-white text-11 font-weight-400 mb-2 px-3">Step 2 of 3</h6>
          <h6 class="text-white text-14 font-weight-500 mb-4 px-3">Payment Methods</h6>
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                <img src="/video_next_app/images/apple.svg" style="width:40px;">
                <img src="/video_next_app/images/google.svg" style="width:40px;">
                <img src="/video_next_app/images/fb.svg" style="width:40px;">
                <img src="/video_next_app/images/twitter.svg" style="width:40px;">
              </div>
        ...
        <div class="plan-sec2  mt-4" v-if="crnt_tab=='pay'">
          <h6 class="text-white text-11 font-weight-400 mb-2 px-3">Step 3 of 3</h6>
          <h6 class="text-white text-14 font-weight-500 mb-4 px-3">Payment</h6>
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
...
.plan-card{
  background-color:white;
    ...
    background-image: linear-gradient(0deg, #030105db, #070707b8), url(/video_next_app/images/bg-gif2.gif)!important;
...
.plan-card2{
  background:linear-gradient(rgb(106, 10, 3), transparent);
