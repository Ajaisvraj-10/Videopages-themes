...
<template>
  <div class="main-content main-content-2" :class="mode=='light'?'mode_change':''">
        ...
        <div class="site-wrapper2" :class="menu_click?'nav-active':''">
            ...
            <footer class="footer py-4 px-2" >
                    <div class="flex-align2" style="flex-wrap:wrap;gap:20px;">
                        <div class="flex-align3" style="gap:10px;">
                            <h6 class="text-14">Download Apps</h6>
                            <img src="/video_next_mobile/images/play_store.png">
                            <img src="/video_next_mobile/images/app_store.png">
                        ...
                        <div class="flex-align3 social2" >
                            ...
                            <a v-for="social_link in social_links" :href="social_link.link" target="_blank"><i :class="social_link.icon"></i></a>
                                    ...
                                    <div class="text-center mb-3">
                                        <img src="/video_next_mobile/images/logo.png"  class="logo my-4" style="max-width:100px!important;max-height:80px;">
                                        ...
                                        <h6 class="text-13 text-light p-2">© 1996-2022, video_next_mobile.com, Inc. or its affiliates </h6>
                                    </div>
            </footer>
        </div>
  </div>
