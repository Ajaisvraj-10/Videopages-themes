          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                <img src="/video_next_mobile/images/apple.svg" style="width:40px;">
                <img src="/video_next_mobile/images/google.svg" style="width:40px;">
                <img src="/video_next_mobile/images/fb.svg" style="width:40px;">
                <img src="/video_next_mobile/images/twitter.svg" style="width:40px;">
              </div>
...
.plan-card{
  background-color:white;
    ...
    background-image: linear-gradient(0deg, #030105db, #070707b8), url(/video_next_mobile/images/bg-gif2.gif)!important;
