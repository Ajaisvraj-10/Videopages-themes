...
<template>
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper"> 
        ...
        <div class="px-3 py-2 w-100 flex-align" >             
          ...
          <div class="header-logo mt-2">
              ...
              <img src="/video_next_mobile/images/logo.png" class="logo">
        ...
        <div class="login-am" v-if="crnt_tab=='login'">
              <h1 class="text-34 font-weight-500 mt-4" style="font-family: 'Raleway', sans-serif;">Welcome <br>back</h1>
                ...
                <div class="my-5">
                  <form ref="loginUser" @submit.prevent="loginUser()">
                    ...
                    <div class=" mb-3 text-right">
                        ...
                        <span><a  style="color: #cfcf05;">Forgot password?</a></span>
                    ...
                    <div class="text-center my-3">
                      ...
                      <span class="text-13  mx-1" style="color: #cfcf05;" @click="crnt_tab='register'">Register</span>
        ...
        <div class="signin-am" v-if="crnt_tab=='register'">
            <h1 class="text-34 font-weight-500 mt-4" style="font-family: 'Raleway', sans-serif;">Signup to <br>get started</h1>
            <div id="signInBorder" class="signin-2 mt-5">
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <div class="text-center  my-3">
                    ...
                    <span class="text-13 text-white">By proceeding you agree to our <a  style="color: #cfcf05;">Terms of service & privacy policy </a></span>
              ...
              <div class="text-center my-3">
                ...
                <span class="text-13 cursor-pointer mx-1" style="color: #cfcf05;" @click="crnt_tab='login'">Login</span>
...
.capcee-login .site-wrapper {
     background: linear-gradient(rgb(74 6 2), black);
       height:100vh;
       overflow:auto;
