...
<template>
  <div class="main-content main-content-2" :class="mode=='light'?'mode_change':''">
    ...
    <div class="site-wrapper2 video-wrapper" :class="menu_click?'nav-active':''">   
            ...
            <div>
                <div class="px-3 pt-3 w-100" style="position:absolute;top:0; left:0; width:100%;z-index: 9999;" >    
                    <router-link :to="edit?'':{name:'home'}" >
                        <a class="video-back-btn">
                            <i class="fa fa-angle-left" style="font-size:26px;color:white;"></i>
                        </a>
                    </router-link>
                </div>
                
                <div v-if="current_movie.id && start" class="position-relative">
                    <div style="
                    position: absolute;
                    z-index: 9;
                    left: 0;
                    ...
                    -webkit-filter: blur(8px) brightness(0.3);">
                         <img :src="current_movie.mobile_thumbnail?api_url+current_movie.mobile_thumbnail:api_url+current_movie.thumbnail"  class="h-100 w-100 thumb_img" @click="playMovie()">
                    </div>
                    <div class="app-video-details position-relative" style="z-index:99;">
                        ...
                        <!--<div class="flex-align plan-banner" v-if="!frontent_settings.have_plan">
                            ...
                            <router-link :to="edit?'':{name:'plan'}">
                                ...
                                <img src="/video_next_mobile/images/king.png" style="width:16px;" class="mr-1">BUY PLAN</button>
                            </router-link>
...
<script>
import MainHeader from '/src/views/app/video_next_mobile/header'
export default {
