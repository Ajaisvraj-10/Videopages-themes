  ...
  <div class="main-content capcee-plan">
    ...
    <div class="site-wrapper"> 
        <header class="header-holder-2" >             
                <div class="menu-wrapper  d-flex align-items-center justify-content-between" style="background:initial;min-height:50px;background-color: #0c112d;"> 
                    <div class="flex-align3">         
                        
                            <router-link to="/">
                                <img src="/video_player_mobile/images/prev.png" style="width:16px;">
                            </router-link>               
        ...
        <div class="plan-container">
          ...
          <img src="/video_player_mobile/images/bg1.jpg" style="max-height:25vh;object-fit:cover;width:100%;object-position:top;">
          <div class="plan-sec " v-if="crnt_tab=='plans'">
            <div class="mt-4"> 
              <h6 class="text-white text-14 font-weight-400 mb-2">Step 1 of 3</h6>
              <h6 class="text-white font-weight-500 mb-4">Subscribe to {{current_plan.name}}</h6>
            </div>
            <div class="plan-card row mx-0">
              ...
              <div class="col-lg-6 plan-card-col">
                <div class="mb-3 rounded" v-for="plan in plans" v-if="plan.status" :style="plan.id==current_plan.id?'background: mb-3 rounded;':'background: initial;'" @click="current_plan=plan">
                    ...
                    <div class="d-flex align-items-center justify-content-between ">
                      <div class="flex-align3" style="gap:15px;">
                        <template v-if="plan.id==current_plan.id">
                          <i class="fa fa-check  flex-align2 rounded-circle" style="width:22px;height:22px;background-color:#ffd376;color: #382d15;font-size: 12px;"></i>
                        </template>
                        <template v-else>
                          <i class=" flex-align2 rounded-circle text-white" style="width:22px;height:22px;cursor:pointer;border:2px solid #ffd376;font-size: 12px;"></i>
                        </template>
                      ...
                      <div class="flex-align3" >
                        ...
                        <div class="text-14">
                           <!-- <sup class=" ">₹999</sup> -->
                           <span class=" text-20 font-weight-400 " style="color:#ffd376;">{{plan.currency_symbol}}{{plan.price}}</span>
                        </div>
            ...
            <div class="plan-card2 row mx-0">
              <div class="col-md-12 p-0 plan-card-col">
                ...
                <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                  <img src="/video_player_mobile/images/apple.svg" style="width:40px;">
                  <img src="/video_player_mobile/images/google.svg" style="width:40px;">
                  <img src="/video_player_mobile/images/fb.svg" style="width:40px;">
                  <img src="/video_player_mobile/images/twitter.svg" style="width:40px;">
                </div>
          ...
          <footer class="footer p-3" >
                    <div class="flex-align" style="flex-wrap: wrap; gap: 25px;">
                        <div class="flex-align3" style="gap:10px;">
                            ...
                            <img src="/video_player_mobile/images/play_store.png">
                            <img src="/video_player_mobile/images/app_store.png">
...
.capcee-plan .btn-primary{
     border-color: #0c112d;
    background: linear-gradient(96deg,#283785,#131c4c 100%);
}
...
.plan-card .plan-card-col:first-child{
  background:linear-gradient(219deg, #090b19, #151a36, #12193f);
  border-radius:10px;
