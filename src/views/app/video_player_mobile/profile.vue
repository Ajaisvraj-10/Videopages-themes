        ...
        <div class="profile-container">
            ...
            <b-card no-body>
              <b-tabs pills card vertical>
                <b-tab title="My Profile" active>
                  <div class="profile-tab" v-if="view_profile">
                    <div class="pb-4 tabs-heading">
                      <h6 class="font-weight-600">My Profile</h6>
                    </div>
                  ...
                  <div class="profile-editing-tab"  v-else>
                    <div class="pb-4 tabs-heading">
                      <h6 class="font-weight-600">Edit Profile</h6>
                    </div>
                ...
                <b-tab title="My Watchlist" @click="userWatch()">
                  <div class="pb-4 tabs-heading">
                    <h6 class="font-weight-600">My Watchlist</h6>
                  </div>
                ...
                <b-tab title="My Subcription" @click="mySubscription()">
                  <div class="pb-4 tabs-heading">
                    <h6 class="font-weight-600">My Subscription</h6>
                  </div>
                  <div class="profile-tab">
                ...
                <b-tab title="My Rentals" @click="myRents()">
                  <div class="pb-4 tabs-heading">
                    <h6 class="font-weight-600">My Rentals</h6>
                  </div>
                  <div class="profile-tab">
                    <table class="table table-striped">
                        <tr class="bg-dark">
                ...
                <b-tab title="My Transactions" @click="myTransactions()">
                  <div class="pb-4 tabs-heading">
                    <h6 class="font-weight-600">My Transactions</h6>
                  </div>
                  <div class="profile-tab">
                    <table class="table table-striped">
                        <tr class="bg-dark">
          ...
          <footer class="footer  p-4" >
                    <div class="flex-align" style="flex-wrap: wrap; gap: 20px;">
                        <div class="flex-align3 mx-auto" style="gap:10px;">
                            <h6 class="text-12">Download Apps</h6>
                            <img src="/video_player_mobile/images/play_store.png">
                            <img src="/video_player_mobile/images/app_store.png">

                        </div>
                        <div class="flex-align3 social2 mx-auto" >
                            <h6 class="text-12 mr-2">Connect with us</h6>
...
.profile-tab .table th, .profile-tab .table td {
