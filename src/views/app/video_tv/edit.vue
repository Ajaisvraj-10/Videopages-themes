  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='video_tv'">
...
<script>
import SignInPage from '/src/views/app/video_tv/sign-in'
import HomePage from '/src/views/app/video_tv/home'
import PlanPage from '/src/views/app/video_tv/plan'
import VideosPage from '/src/views/app/video_tv/movies'
import WatchingPage from '/src/views/app/video_tv/video'
export default {
  components: {
    SignInPage,
    HomePage,
