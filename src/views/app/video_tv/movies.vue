...
<template>
  <div class="main-content main-content-2" :class="mode=='light'?'mode_change':''">
        ...
        <div class="site-wrapper2" :class="menu_click?'nav-active':''">
            ...
            <div class="position-relative p-4 " style="margin-top:80px;">
                <h6 class="text-14 my-3 px-2 font-weight-600" v-if="type=='search'">Search results ({{$route.query.tag}})</h6>
                <h6 class="text-14 my-3 font-weight-600 px-2" v-else>List {{slugToWord(category)}} for you</h6>
                <div class="row m-0">
