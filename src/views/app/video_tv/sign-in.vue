...
<template>
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper" v-if="start"> 
        <img src="/video_tv/images/bg1.jpg" class="signin-bg">
        
        <div class="login-am signin-forms" v-if="crnt_tab=='login'">
              
            <div id="signInBorder" class="signin-2">
              <router-link :to="edit?'':{name:'home'}">
                <i class="fa fa-close text-gray" style="position:absolute;top:5%;right:5%;"></i>
              </router-link>
              ...
              <form ref="loginUser" @submit.prevent="loginUser()">
                ...
                <div class="text-center mt-1 mb-2">
                    ...
                    <span><a  style="color: #fff;">Forgot password?</a></span>
              ...
              <div class="text-center my-3">
                ...
                <span class="text-13 cursor-pointer mx-1" style="color: #fff;" @click="crnt_tab='register'">Register</span>
        ...
        <!--<div class="otp-am signin-forms" v-if="crnt_tab=='otp'">
        ...
        <div class="signin-am signin-forms" v-if="crnt_tab=='register'">
            <div id="signInBorder" class="signin-2">
              <router-link :to="edit?'':{name:'home'}">
                <i class="fa fa-close text-gray" style="position:absolute;top:5%;right:5%;"></i>
              </router-link>
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <!--<div class="text-center  my-3">
                    ...
                    <span class="text-13 text-white">By proceeding you agree to our <a  style="color: #fff;">Terms of service & privacy policy </a></span>
              ...
              <div class="text-center my-3">
                ...
                <span class="text-13 cursor-pointer mx-1" style="color: #fff;" @click="crnt_tab='login'">Login</span>
              ...
              <div class=" my-3" >
                  ...
                  <button  class=" w-100 d-flex align-items-center justify-content-center" style="border:1px solid #fff;cursor:pointer;border-radius:5px;background-color:initial;color:#fff;height:44px;">
...
#capcee{
  ...
  border: 1px solid #de146d;
  border-radius:5px;
  margin-top: 10px;
  cursor:pointer;
  background: linear-gradient(270deg,#de146d,#d21f49);
  font-weight:600;
}
