...
<template>
  <div class="main-content main-content-2 video-page" :class="mode=='light'?'mode_change':''">
        ...
        <div class="site-wrapper2" :class="menu_click?'nav-active':''">
            ...
            <div class="row videopage-row position-relative mx-0" style="margin-top:72px;background-color: black;" v-if="current_movie.id && start">
                <img :src="api_url+current_movie.thumbnail"  class="video-bg" @click="playMovie()" >
                <div class=" col-lg-6 col-md-7 px-3 px-lg-5" style="z-index: 9;">
                       
                        <div class="video-controls mb-2">
                            <div class="w-100">
                                <div class="w-100 " style="position: relative;z-index: 999;">
                                    
                                    <h5 class="text-30 my-2 font-weight-700 text-white main-heading-1 ">{{current_movie.name}}</h5>

                                    <div class="ratings flex-align3 my-3" style="gap:10px;">
                                        <!--<span class="text-10 border font-weight-800 rounded" style="padding:2px 3px;">IMDB</span>-->
                                        
                                        <h6 class="font-weight-500 text-15 mr-2">{{current_movie.message}}</h6>
                                        
                                       
                                        <h6 class="font-weight-500 text-15">2 h 38 min</h6>
                                        <h6 class="font-weight-500 text-15">2022</h6>
                                ...
                                <div class="my-3">
                                        ...
                                        <button class="btn text-white px-4 py-3" style="background:linear-gradient(270deg,#de146d,#d21f49);font-weight:500!important;font-size:16px;">
                                            
                                           <i class="fa fa-play mr-2"></i> Watch Video
                                        </button>
                                        
                                </div>
                                
                                <div class="w-100">
                                    <h4 class="text-14 mb-3 font-weight-400 text-white main-heading-2" style="line-height:20px;">{{current_movie.description}}</h4>
                                </div>
                                    
                                   
                                
                                <div class="stars mb-3" style="opacity:.8;">
                                    <div class="flex-align3 mb-2" v-for="movie_spec in current_movie.specs">
                                        <h6 class="text-14 text-white font-weight-600 pr-2" style="min-width:150px;">{{movie_spec.label}}</h6>

                                        <h6 class="text-14 font-weight-600 pr-2" style="min-width:150px;">: {{movie_spec.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-2">
                                        <h6 class="text-14 text-white font-weight-600 pr-2" style="min-width:150px;">Genres</h6>

                                        <h6 class="text-14 font-weight-600 pr-2" style="min-width:150px;">: {{current_movie.category_detail.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-2">
                                        <h6 class="text-14 text-white font-weight-600 pr-2" style="min-width:150px;">Language</h6>

                                        <h6 class="text-14 font-weight-600 pr-2" style="min-width:150px;">: {{current_movie.language_detail.name}}</h6>
                                    </div>
                ...
                <div class="col-lg-6 col-md-5 px-3 px-lg-5 my-2 my-md-5" style="z-index: 9;display: flex;align-items: center;">
                     <div class=" w-100" v-if="current_movie.message=='play'">
                    ...
                    <div class="cursor-pointer w-100" v-else>
                        <img :src="api_url+current_movie.thumbnail"  class=" w-100 thumb_img" style="border-radius:14px;" @click="playMovie()">
                    </div>
                    ...
                    <div class="plan-card2 row mx-0">
                      <div class="col-md-12 plan-card-col">
                        ...
                        <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                          <img src="/video_tv/images/apple.svg" style="width:40px;">
                          <img src="/video_tv/images/google.svg" style="width:40px;">
                          <img src="/video_tv/images/fb.svg" style="width:40px;">
                          <img src="/video_tv/images/twitter.svg" style="width:40px;">
                        </div>
...
<script>
import MainHeader from '/src/views/app/video_tv/header'
import MainFooter from '/src/views/app/video_tv/footer'
export default {
...
<style scoped>
  ...
  @import '/video_tv/style/style-2.css';
  /*.thumb_img:hover{
    opacity:0.5;
  }*/
</style>
