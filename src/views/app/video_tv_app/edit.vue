  ...
  <div>
    ...
    overflow: hidden;">
      <div class="col-lg-4 border-right " style="height:100vh;overflow:auto;padding:25px;">
        <div class="card border shadow-2 w-100 mb-4"  v-if="current_block.id">
          <form id="blockForm"  @submit.prevent="updateBlock()" >
            ...
            <div class="px-3 pt-2" v-if="current_block.input_type=='file'">
      ...
      <div class="col-lg-8 px-0 text-center">
        <div class="mt-0" style="position:relative;width:320px;height:680px" v-if="themename=='video_tv_app'">
...
<script>
import SignInPage from '/src/views/app/video_tv_app/sign-in'
import HomePage from '/src/views/app/video_tv_app/home'
import PlanPage from '/src/views/app/video_tv_app/plan'
import VideosPage from '/src/views/app/video_tv_app/movies'
import WatchingPage from '/src/views/app/video_tv_app/video'
export default {
  components: {
    SignInPage,
    HomePage,
      ...
      .then((jsonData) => {
        ...
        for(var i=0;i<this.blocks.length;i++){
          if(this.blocks[i].movie_type!='None'){
            this.blocks[i].movies = this.paginationMovies(this.blocks[i].movies,2)
          }
        }
      })
    },
