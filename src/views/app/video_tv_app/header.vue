    ...
    <div>
        ...
        <header class="header-holder-2" :class="search_page=='open'?'sidebar_active':''">             
            <div class="menu-wrapper  d-flex align-items-center justify-content-between"> 
                <div class="text-center header-right flex-align3" style="gap:10px;" >
                        ...
                        <div class="search-input" @click="search_page='open'">
                            <img src="/video_tv_app/images/search.png" class="mr-2">
                        </div>
                        <div class="search_section">
                            ...
                            <div class="search-box mx-2">
                                <div class="search-bar">
                                    <img src="/video_tv_app/images/search.png" class="" style="width:22px;">
                ...
                <div class="text-center header-right flex-align3" style="gap:10px;" >
                        ...
                        <div class="mobile-menu" v-b-toggle.sidebar-1>
                            <img src="/video_tv_app/images/myphoto.jpg" class="profile-pic">
                            <img src="/video_tv_app/images/myphoto2.jpg"class="profile-pic profile-2">
            ...
            <b-sidebar id="sidebar-1" title="Sidebar" no-header right width="100%" shadow>
                <div class="search-header w-100">
                    ...
                    <img src="/video_tv_app/images/nav_left.png" style="width:20px;" v-b-toggle.sidebar-1>
                ...
                <div class="sidebar-header p-4 mx-3 flex-align" >
                    <div  class="flex-align3" style="gap:20px;">
                        <div class="user-img position-relative">
                            <img src="/video_tv_app/images/myphoto.jpg" class="profile-pic" style="width:45px!important;height:45px!important;">
                            <img src="/video_tv_app/images/myphoto2.jpg"class="profile-pic profile-2" style="width:45px!important;height:45px!important;">
                        </div>
        ...
        <div class="footer-app">
            ...
            <div class="footer-item active-footer-item">
                <img src="/video_tv_app/images/home-active.png">
                <h6>Home</h6>
            </div>
            </router-link>
            <router-link to="/plan">
            <div class="footer-item">
                <img src="/video_tv_app/images/plan.png">
                <h6>Plan</h6>
            </div>
            </router-link>
            <router-link to="/profile">
            <div class="footer-item">
                <img src="/video_tv_app/images/profile2.png">
                <h6>Profile</h6>
            </div>
            </router-link>
            <router-link to="/sign-in">
            <div class="footer-item">
                <img src="/video_tv_app/images/login.png">
                <h6>Login</h6>
            </div>
            </router-link>
        </div>
...
<style scoped>
  ...
  @import '/video_tv_app/style/style-2.css';
...
#capcee {
    ...
    font-size: 20px;
    color: lightgray;
    background:linear-gradient(45deg, #e1136f, #441724);
