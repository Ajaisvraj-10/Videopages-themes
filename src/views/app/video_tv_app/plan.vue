...
<template>
  <div class="main-content capcee-plan">
    ...
    <div class="site-wrapper"> 
      <div class="search-header w-100 mb-0">
            <router-link :to="edit?'':{name:'home'}" class="float-left">
              <img src="/video_tv_app/images/nav_left.png" style="width:20px;" @click="search_page='close'">
            </router-link>
            <div class="header-logo">
                <router-link :to="edit?'':{name:'home'}">
                  <img src="/video_tv_app/images/logo.png" class="logo">
                </router-link>             
            </div>
            <div></div>
                                
      </div>
      <div class="w-100 plan-header" >
        
      </div>
      <div class="plan-container">
        <!--<div class="plan-banners mb-4">
          <img src="/video_tv_app/images/bg1.jpg">
        </div>-->
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          <h6 class="text-white text-14 font-weight-500 text-center mb-4 pb-3">Choose your premium plan</h6>
          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-12 plan-card-col" style="display: flex;width: 100%;gap: 20px;overflow: auto;">
              <div class="plans-card mb-3" v-for="plan in plans" :style="plan.id==current_plan.id?'background: #e1136f;border:2px solid transparent; border-radius:6px;':'background: #1a2224;border-radius:6px;border:2px solid #f8f9f9;'" @click="current_plan=plan">
                <div class="px-3 pt-2 rounded2-top position-relative" >
                  ...
                  <div class="flex-align">
                    ...
                    <h4 class="text-white font-weight-500  mb-0 text-14">
                          {{plan.duration}} {{plan.date_type}} plan
                    </h4>
                        
                    <!-- <sup class="text-white ">₹999</sup> -->
                    <span class="text-white text-20 font-weight-600 ">{{plan.currency_symbol}}{{plan.price}}</span>
                  
                  </div>
                </div>
                <div class="rounded2-bottom px-2 pb-3 pt-2  text-center text-white text-14 font-weight-500" >
                  <h6 class="text-12 text-white">
                    {{plan.description}}
                  </h6>
            ...
            <div class="purchase-button" v-if="current_plan.id" @click="getPaymentMethods();crnt_tab='payment_methods'">
              Continue with {{current_plan.currency_symbol}}{{current_plan.price}}
            </div>
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                ...
                <img src="/video_tv_app/images/google.svg" style="width:40px;">
                <img src="/video_tv_app/images/fb.svg" style="width:40px;">
                <img src="/video_tv_app/images/twitter.svg" style="width:40px;">
              </div>
        ...
        <div class="plan-sec2 px-3 mt-5" v-if="crnt_tab=='pay'">
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <button  @click="purchasePlan()" v-if="razorpay_options.key">Pay Now</button>
...
<style scoped>
  ...
  @import '/video_tv_app/style/style.css';
...
.plan-header {
    background-image:linear-gradient(rgb(0 0 0 / 12%), rgb(7 12 15)), url(/video_tv_app/images/bg1.jpg);
    min-height: 120px;
...
.btn-primary {
    ...
    background: linear-gradient(to left, #313131, #272727)!Important;
