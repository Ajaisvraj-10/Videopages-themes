  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 text-center">
        <div class="mt-0" style="position:relative;width:320px;height:680px" v-if="themename=='videocinema_app'">
...
<script>
import SignInPage from '/src/views/app/videocinema_app/sign-in'
import HomePage from '/src/views/app/videocinema_app/home'
import PlanPage from '/src/views/app/videocinema_app/plan'
import VideosPage from '/src/views/app/videocinema_app/movies'
import WatchingPage from '/src/views/app/videocinema_app/video'
export default {
  components: {
    SignInPage,
    HomePage,
...
<style scoped>
  ...
  @import '/videocinema_app/style/style-2.css';
.combonent_class{
