    ...
    <div>
            ...
            <div class="menu-wrapper  d-flex align-items-center justify-content-between"> 
                ...
                <div class="text-center header-right flex-align3" style="gap:10px;" >
                        ...
                        <div class="search-input" @click="search_page='open'">
                            <img src="/videocinema_app/images/find.png" class="">
                        </div>
                        <div class="search_section">
                            <div class="search-header">
                                <img src="/videocinema_app/images/prev.png" @click="search_page='close'" style="width:20px;">
                                <div class="search-bar">
                                    <img src="/videocinema_app/images/search.svg" class="ml-2">
        ...
        <footer class="footer-holder-2">             
                ...
                <div>
                    ...
                    <h6>{{$root.token?'UPGRADE':'BUY PLAN'}}</h6>
                </div> 
                </router-link>
