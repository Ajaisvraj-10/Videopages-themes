...
<template>
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper"> 
        ...
        <div class="px-3 flex-align3 py-2 w-100" style="gap:10px;">             
        ...
        <div class="header-logo">
                        <router-link :to="edit?'':{name:'home'}">
                            <img src="/videocinema_app/images/logo.png" class="logo2" >
                        </router-link>             
        </div>
            ...
            <div id="signInBorder" class="signin-2">
              <div class="text-center">
                ...
                <div class="d-flex justify-content-center my-3" style="gap:20px;">
                  <img src="/videocinema_app/images/apple.svg" style="width:40px;">
                  <img src="/videocinema_app/images/google.svg" style="width:40px;">
                  <img src="/videocinema_app/images/fb.svg" style="width:40px;">
                  <img src="/videocinema_app/images/twitter.svg" style="width:40px;">
                </div>
              </div>
            ...
            <div id="signInBorder" class="signin-2 mt-5">
              <div class="text-center">
                ...
                <div class=" my-3" >
                  ...
                  <button  class=" w-100 d-flex align-items-center justify-content-center" style="border-radius:25px;background-color:white;color:#D9008D;">
                    <img src="/videocinema_app/images/google.svg" style="width:45px;heoght:45px;"> 
                    Sign in
                  </button>
...
<style scoped>
  ...
  @import '/videocinema_app/style/style.css';
...
.capcee-login input:-webkit-autofill:hover, 
.capcee-login input:-webkit-autofill:focus, 
.capcee-login input:-webkit-autofill:active{
    -webkit-box-shadow: 0 0 0 30px #0f0617 inset !important;
