     ...
     <div class="site-wrapper">   
        <MainHeader></MainHeader>
            <div id="content" class="site-content center-relative" style="margin-top:-85px;">
              <div id="home" class="section no-page-title" style=" background:linear-gradient(0deg, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.50)), url(/videoflix_web/images/bg1.jpg);background-size: cover;background-position: center left;background-repeat: no-repeat;">  
                    <div class="overlay-in-video-3">
                    </div>                 
                    <div class="section-wrapper block content-1170 center-relative">                                                
                        <div class="content-wrapper banner-captions text-center mt-5 pt-5">                           
                            <h1 class="big-text banner-text text-center" @click="selectContent(blocks[0])" :class="blocks[0].is_edit?'selected_content':''" :id="'blocks_'+blocks[0].id" v-show="blocks[0].status">
                               <span>{{blocks[0].value}}</span>
                            </h1>
                            <h4 class="fadein banner-text-2 text-25 my-2 text-white font-weight-400" @click="selectContent(blocks[1])" :class="blocks[1].is_edit?'selected_content':''" :id="'blocks_'+blocks[1].id" v-show="blocks[1].status">{{blocks[1].value}}</h4>
                            <h4 @click="selectContent(blocks[2])" class="fadein banner-text-3 text-18 mt-4 pt-2 text-white font-weight-400 " :class="blocks[2].is_edit?'selected_content':''" :id="'blocks_'+blocks[2].id" v-show="blocks[2].status">{{blocks[2].value}}</h4>
                ...
                <div id="about" class="section">                   
                        ...
                        <div class="content-wrapper d-flex  align-items-center">
                            ...
                            <div class="one_half last" >
                              <div class="video-in-image">
                                <img src="/videoflix_web/images/tv.png" alt="" /> 
                                <img src="/videoflix_web/images/tv.png" alt="" class="gif-vid-parts" />
                    ...
                    <div class="section-wrapper order-0 content-1170 center-relative ">                                                
                        <div class="content-wrapper d-flex align-items-center">
                            <div class="one_half last" >
                                <div class="video-in-image">
                                    <img :src="blocks[3].value?blocks[3].image:api_url+blocks[3].image" alt="" @click="selectContent(blocks[3])" :class="blocks[3].is_edit?'selected_content':''" :id="'blocks_'+blocks[3].id" v-show="blocks[3].status"/> 
                    ...
                    <div class="section-wrapper  block content-1170 center-relative">                                                
                        <div class="content-wrapper d-flex align-items-center">
                            ...
                            <div class="one_half last" >
                              <div class="video-in-image">
                                <img src="/videoflix_web/images/device-pile-in.png" alt="" /> 
                                <img src="/videoflix_web/images/device.png" alt="" class="gif-vid-parts" />   
                    ...
                    <div class="section-wrapper order-0 block content-1170 center-relative">                                                
                        <div class="content-wrapper d-flex align-items-center">
                            <div class="one_half last" >
                              <div class="video-in-image">
                                <img src="/videoflix_web/images/children.png" alt="" /> 
...
<script>
import MainHeader from '/src/views/app/videoflix_web/header'
export default {
