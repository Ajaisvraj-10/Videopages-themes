  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='videofy'">
...
<script>
import SignInPage from '/src/views/app/videofy/sign-in'
import HomePage from '/src/views/app/videofy/home'
import PlanPage from '/src/views/app/videofy/plan'
import VideosPage from '/src/views/app/videofy/movies'
import WatchingPage from '/src/views/app/videofy/video'
export default {
  components: {
    SignInPage,
    HomePage,
