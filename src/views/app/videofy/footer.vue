        ...
        <footer class="footer py-md-4 px-md-5" >
            <div class="flex-align" style="flex-wrap:wrap;gap:25px;">
                <div class="flex-align3" style="gap:10px;">
                    ...
                    <a class="d-flex" :href="site_footer.playstore_link" target="_blank" v-show="site_footer.is_playstore"><img src="/videofy/images/play_store.png"></a>
                    <a class="d-flex" :href="site_footer.appstore_link" target="_blank" v-show="site_footer.is_appstore"><img src="/videofy/images/app_store.png"></a>
