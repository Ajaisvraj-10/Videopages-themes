...
<template>
  <div class="main-content main-content-2 capcee-plan">
    ...
    <div class="site-wrapper"> 
      ...
      <!--<div class="px-3 py-2 w-100 plan-header" >
        <div class="row align-items-center">
            ...
            <div class="text-right  col-4 flex-align3" style="display: flex;justify-content: flex-end;">
                      <div v-if="$root.token">
      ...
      <div id="content" class="site-content main-content-sec center-relative">
        ...
        <div class="plan-container position-relative second-section main-page-sec p-0">
          <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
            <!--<h5 class="plan-head">Choose Your Plan</h5>
            ...
            <div class="plan-card row mx-0">
              ...
              <div class="col-md-12 plan-card-col pt-3" style="display: flex;width: 100%;gap: 20px;overflow: auto;">
                <div class="plans-card mb-3 pb-3 px-2 pt-4" :style="plan.id==current_plan.id?'background: #181818; border-radius:6px;border:1px solid #007bdd;':'background: #343535;'" @click="current_plan=plan" v-for="plan in plans">
                  <div class="choosed-btn" >
                        
                        <template v-if="plan.id==current_plan.id">
                          <h6 class="choose-h">Choosed</h6>
                        </template>
                        <template v-else>
                          
                          <h6 style="display:none;" @click="current_plan=plan">Choose</h6>
                        </template>
                  </div>
                  <div class=" position-relative mx-auto" >
                    ...
                    <div class="d-flex align-items-center justify-content-between ">
                      <div >
                        <div class="text-white font-weight-500  text-14">
                  ...
                  <div class="rounded2-bottom  pt-2 text-center text-white text-14 font-weight-400" >
                    <div class="text-12">
                      {{plan.description}}
                    </div>
                    <div class="text-12 mt-2">
                           <!-- <sup class="text-white ">₹999</sup> --><span class="text-white text-18 font-weight-700 ">{{plan.currency_symbol}}{{plan.price}}</span>
                    </div>
                  </div>
              ...
              <div class="purchase-button">
                <button class="btn btn-info w-100  py-2" v-if="current_plan.id" @click="getPaymentMethods();crnt_tab='payment_methods'">Continue with {{current_plan.currency_symbol}}{{current_plan.price}}</button>
              </div>
          ...
          <div class="plan-sec2 px-3 mt-5" v-if="crnt_tab=='payment_methods'">
            ...
            <div class="plan-card2 row mx-0">
              <div class="col-md-12 plan-card-col">
                ...
                <button class="btn btn-info rounded2 py-2 w-100 my-2" v-for="payment_method in payment_methods" @click="setRazorpay(payment_method);crnt_tab='pay'">{{payment_method.name}}</button>
          ...
          <div class="plan-sec2 px-3 mt-5" v-if="crnt_tab=='pay'">
            ...
            <div class="plan-card2 row mx-0">
              <div class="col-md-12 plan-card-col">
                ...
                <button class="btn btn-info rounded2 py-2 w-100 my-2" @click="purchasePlan()" v-if="razorpay_options.key">Pay Now</button>
...
.plan-sec{
  ...
  //background-image:linear-gradient(rgb(0 0 0 / 70%), #000), url(/videofy/images/bg1.jpg);
}
.plan-card{
  max-width:720px;
...
.plan-header {
    //background-image:linear-gradient(rgb(0 0 0 / 12%), #000), url(/videofy/images/bg1.jpg);
    min-height: 120px;
...
.btn-danger {
    ...
    background-color: #bb0b14!important;
    border-color: #bb0b14!Important;
}
.purchase-button {
