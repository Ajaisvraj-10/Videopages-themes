                  ...
                  <b-tabs pills card vertical>
                    <b-tab title="My Profile" active>
                      <div class="profile-tab" v-if="view_profile">
                        ...
                        <div class="flex-align3 py-4 profile-scroll-right" style="gap:15px;align-items:flex-start;">
                      ...
                      <div class="profile-editing-tab"  v-else>
                        ...
                        <form ref="updateProfile" class="profile-scroll-right" @submit.prevent="updateProfile()">
                            <div class="edit-profile col-lg-7 mx-auto" style="">
                            ...
                            <div class=" col-lg-7 mx-auto" style="border-top: 0.5px solid #484848!important;">
                    ...
                    <b-tab title="My Watchlist" @click="userWatch()">
                      ...
                      <div class="profile-tab profile-scroll-right">
                         <div class="row m-0">
                            <div class="col-2 p-2" v-for="watch in user_watchs">
                                <div class="image-row" >
                                      ...
                                      <router-link :to="edit?'':{name:'video',params: { type: slugify(watch.movie_detail.type), category: slugify(watch.movie_detail.category_detail.name), slug: watch.movie_detail.slug }, query: {language:watch.movie_detail.language_detail.name}}">
                                          <div class="position-relative" >
                                              ...
                                              <div class="hover-modal-div">
                                                  ...
                                                  <div class="small-details p-2">
                                                      <h5 class="text-12 font-weight-500  text-white">{{watch.movie_detail.name}}</h5>
...
.active_btn {
    background-color: #3f324c!important;
    border: 1px solid #3f324c!important;
...
.profile-scroll-right .bg-dark{
    background: #0e0e0e!important;
}
.profile-scroll-right table, th, td {
   
    border: none!important;
}
.second-section .profile-scroll-right .image{
    width:100%;
    padding:0;
}
