...
<template>
  <div class="main-content capcee-login">
    <div class="site-wrapper  py-3" v-if="start"> 
        <div class="videofy-signin-logo" >
          <router-link :to="edit?'':{name:'home'}">
            <img src="/videofy/images/prev.png" class="back-btn">
          </router-link>
          <router-link to="/">
            <img src="/videofy/images/logo.png" class="" style="max-width:120px;max-height:60px;">
          </router-link>             
        </div>
