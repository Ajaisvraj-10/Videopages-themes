        ...
        <div class="site-wrapper" :class="menu_click?'nav-active':''">
          <MainHeader :edit="edit" :blocks="blocks" :current_block="current_block"></MainHeader>
            <div id="content" class="site-content main-content-sec center-relative">
                <div class="row mx-0 p-0 position-relative second-section main-page-sec"  v-if="current_movie.id && start">
                                ...
                                <div class="w-100">
                                    <div class=" " style="position: relative;z-index: 999;">
                                        ...
                                        <div class="ratings flex-align3 my-3" >
                                            <div class="flex-align3 mr-2">
                                                <span class="text-10 border font-weight-500 rounded mr-2" style="padding:2px 3px;">IMDB</span>
                                                <h6 class="font-weight-500 text-15 mr-2">{{current_movie.message}}</h6>
                                            </div>
                                            <div class="flex-align3 mr-2">
                                                
                                                <h6 class="font-weight-500 text-15 mr-2 text-nowrap">2 h 38 min</h6>
                                                <h6 class="font-weight-500 text-15 mr-2">2022</h6>
                                            </div>
                                    ...
                                    <div class="stars my-3" >
                                        <div class="flex-align3 my-1" v-for="movie_spec in current_movie.specs">
                                            <h6 class="text-16 text-white font-weight-400 pr-2">{{movie_spec.label}}</h6>

                                            <h6 class="text-16 font-weight-400 pr-2">: {{movie_spec.name}}</h6>
                                        </div>
                                        <div class="flex-align3 mb-3">
                                            <h6 class="text-16 text-white font-weight-400 pr-2" style="min-width:150px;">Genres</h6>

                                            <h6 class="text-16 font-weight-400 pr-2" >: {{current_movie.category_detail.name}}</h6>
                                        </div>
                                        <div class="flex-align3 mb-3">
                                            <h6 class="text-16 text-white font-weight-400 pr-2" style="min-width:150px;">Language</h6>

                                            <h6 class="text-16 font-weight-400 pr-2" >: {{current_movie.language_detail.name}}</h6>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex-align3 modal-icons-2 play-buttons">
                                            <div class="play btn-info flex-align3 py-1 px-4 rounded mr-3 button-control" style="min-height:45px;">
...
.play-video-thumb{
  ...
  .play-video-thumb:before {
    ...
    width: 70px;
     background: url(/all-images/play.png);
    padding:20px;
    border-radius:50%;
    height: 70px;
