  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 text-center">
        <div class="mt-0" style="position:relative;width:320px;height:680px" v-if="themename=='videogama_app'">
...
<script>
import SignInPage from '/src/views/app/videogama_app/sign-in'
import HomePage from '/src/views/app/videogama_app/home'
import PlanPage from '/src/views/app/videogama_app/plan'
import VideosPage from '/src/views/app/videogama_app/movies'
import WatchingPage from '/src/views/app/videogama_app/video'
export default {
  components: {
    SignInPage,
    HomePage,
