...
<template>
    <div :class="background_start?'':'ott-scroll'">
        ...
        <header class="header-holder-2" :class="search_page=='open'?'sidebar_active':''">             
            <div class="menu-wrapper scroll-hide  d-flex align-items-center justify-content-between"> 
                <div class="text-center header-right flex-align3" style="gap:10px;" >
                        <router-link to="/sign-in">
                            <img src="/videogama_app/images/login.png" style="width:26px;">
                        </router-link>
                        
                        <div class="search_section">
                            <div class="search-header">
                                 <img src="/videogama_app/images/close-left-arrow.png" style="width:20px;" @click="search_page='close'">

                                <div class="search-bar">
                                    <img src="/videogama_app/images/search.png" class="" style="width:20px;">
                ...
                <div class="flex-align3">         
                    <div class="header-logo">
                        <router-link :to="edit?'':{name:'home'}">
                            <img :src="frontent_settings.dark_logo" class="logo">
                        </router-link>             
                    </div>
                </div>
                <div class="text-center header-right flex-align3" style="gap:10px;" >
                        ...
                        <div class="mobile-menu" v-b-toggle.sidebar-1>
                            <img src="/videogama_app/images/myphoto.jpg" class="profile-pic">
                            <img src="/videogama_app/images/myphoto2.jpg"class="profile-pic profile-2">
                            
                        </div>
                </div>
            </div>
            <div class="search-input scroll-hide" @click="search_page='open'">
                            <img src="/videogama_app/images/search.png" class="mr-2">
            ...
            <b-sidebar id="sidebar-1" title="Sidebar" no-header right width="100%" shadow>
                <div class="" style="height:50px;">
                    <div class="sidebar-close" v-b-toggle.sidebar-1>
                        <img src="/videogama_app/images/close.png">
                    </div>
                    <div class="header-logo mt-2">
                        <router-link :to="edit?'':{name:'home'}">
                            <img :src="frontent_settings.dark_logo" class="logo mx-auto d-flex">
                        </router-link>
                    </div>
                </div>
                ...
                <div class="sidebar-header p-4 mx-3 flex-align" >
                    <div  class="flex-align3" style="gap:20px;">
                        <div class="user-img">
                            <img src="/videogama_app/images/profile.png" class="rounded-circle" style="width:60px;">
                        </div>
                ...
                <div class="px-3 text-left">
                    ...
                    <router-link :to="edit?'':$root.token?{name:'profile'}:{name:'sign-in'}">
                        <h6 class="text-dark text-18 font-weight-400 m-4 py-1">Buy Plan</h6>
                        <h6 class="text-dark text-18 font-weight-400 m-4 py-1">My Subcription</h6>
                        <h6 class="text-dark text-18 font-weight-400 m-4 py-1">My Transactions</h6>
                        <h6 class="text-dark text-18 font-weight-400 m-4 py-1">Watchlist</h6>
                    </router-link>
                ...
                <div class="px-3 text-left">
                   ...
                   <h6 class="text-dark text-18 font-weight-400 m-4 py-1">Settings</h6>
                </div>
               
                <div class="px-3 text-left">
                    <h6 class="text-dark text-18 font-weight-400 m-4 py-1">About Us</h6>
                </div>
               
                <div class="px-3 text-left">
                    <h6 class="text-dark text-18 font-weight-400 m-4 py-1" @click="signOut()">Sign Out</h6>
                </div>
        ...
        <div class="footer-app">
            ...
            <div class="footer-item active-footer-item">
                <img src="/videogama_app/images/home.png" class="footer-item-img">
                <img src="/videogama_app/images/home2.png" class="footer-item-img-active">
            ...
            <div class="footer-item">
                <img src="/videogama_app/images/king.png" class="footer-item-img">
                <img src="/videogama_app/images/king2.png" class="footer-item-img-active">
            ...
            <div class="footer-item">
                <img src="/videogama_app/images/profile.png" class="footer-item-img">
                <img src="/videogama_app/images/profile2.png" class="footer-item-img-active">
            ...
            <router-link to="/sign-in">
            <!--<div class="footer-item">
                <img src="/videogama_app/images/login.png" class="footer-item-img">
                <img src="/videogama_app/images/login2.png" class="footer-item-img-active">
