...
<template>
  <div class="main-content capcee-plan">
    ...
    <div class="site-wrapper"> 
      <div class="px-3 py-2 w-100 plan-header flex-align" >
        ...
        <router-link :to="edit?'':{name:'home'}">
          <img src="/videogama_app/images/close.png" style="width:16px;">
        </router-link>
      </div>
      <div class="plan-container">
        <!--<div class="plan-banners mb-4">
          <img src="/videogama_app/images/bg1.jpg">
        </div>-->
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          <h6 class="text-dark text-14 font-weight-500 text-center mb-4 pb-3">Choose your premium plan</h6>
          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-12 plan-card-col" style="display: flex;width: 100%;gap: 20px;overflow: auto;">
              <div class="plans-card mb-3" v-for="plan in plans" :style="plan.id==current_plan.id?'background: linear-gradient(to left, #313131, #272727); border-radius:6px;':'background: black;border-radius:6px;border:none;'" @click="current_plan=plan">
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                <img src="/videogama_app/images/apple.svg" style="width:40px;">
                <img src="/videogama_app/images/google.svg" style="width:40px;">
                <img src="/videogama_app/images/fb.svg" style="width:40px;">
                <img src="/videogama_app/images/twitter.svg" style="width:40px;">
              </div>
