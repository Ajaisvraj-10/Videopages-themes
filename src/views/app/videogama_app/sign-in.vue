    ...
    <div class="site-wrapper"> 
        ...
        <div class="pt-5" >             
                    ...
                    <router-link :to="edit?'':{name:'home'}" class="float-left">
                      <div style="width:35px;height:35px;display:flex;align-items:center;justify-content:center;background-color:black;position:absolute;left:0;top:15;">
        ...
        <img src="/videogama_app/images/logo2.png" style="max-width:200px;max-height:60px;">
                ...
                <div class="my-4">
                  <form ref="loginUser" @submit.prevent="loginUser()">
                    ...
                    <div class="text-center mb-3">
                        ...
                        <span><a  style="color: gray;">Forgot password?</a></span>
            ...
            <div id="signInBorder" class="signin-2 mt-4">
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <!--<div class="text-center  my-3">
                    ...
                    <span class="text-13 text-dark">By proceeding you agree to our <a  style="color: gray;">Terms of service & privacy policy </a></span>
