  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='videogate'">
...
<script>
import SignInPage from '/src/views/app/videogate/sign-in'
import HomePage from '/src/views/app/videogate/home'
import PlanPage from '/src/views/app/videogate/plan'
import VideosPage from '/src/views/app/videogate/movies'
import WatchingPage from '/src/views/app/videogate/video'
export default {
  components: {
    SignInPage,
    HomePage,
