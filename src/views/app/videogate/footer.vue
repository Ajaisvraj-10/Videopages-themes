        ...
        <footer class="footer py-md-4 px-md-5 px-2 py-4" >
            <div class="flex-align" style="flex-wrap:wrap;gap:25px;">
                <div class="flex-align3" style="gap:10px;">
                    ...
                    <a class="d-flex" :href="site_footer.playstore_link" target="_blank" v-show="site_footer.is_playstore"><img src="/videogate/images/play_store.png"></a>
                    <a class="d-flex" :href="site_footer.appstore_link" target="_blank" v-show="site_footer.is_appstore"><img src="/videogate/images/app_store.png"></a>
            ...
            <div class="text-center mb-3">
                <img :src="frontent_settings.main_logo" class="logo mt-4 mt-md-2"  style="max-width:160px!important;max-height:80px;" v-show="site_footer.is_logo">
