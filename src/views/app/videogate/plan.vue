    ...
    <div class="site-wrapper"> 
      ...
      <div class="plan-container">
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          <h6 class="text-white text-20 font-weight-500 text-center mb-3 pb-3">Choose your premium plan</h6>
          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-12 plan-card-col pt-3" style="display: flex;width: 100%;gap: 20px;overflow: auto;">
              <div class="plans-card mb-3" v-for="plan in plans" :style="plan.id==current_plan.id?'background: #11313e; border-radius:6px;':'background: black;border-radius:6px;border:none;'" @click="current_plan=plan">
                ...
                <div class="px-3 pb-2 pt-1 rounded2-top position-relative" >
                  ...
                  <div class="d-flex align-items-center justify-content-between ">
                    <div >
                      <div class="text-white font-weight-600  text-14 mb-2">
...
.plan-header {
    background-image:linear-gradient(rgb(0 0 0 / 12%), #11313e), url(/videogate/images/bg1.jpg);
    min-height: 150px;
...
.btn-primary:hover {
    ...
    box-shadow:0 8px 25px -8px #d2ff00;
