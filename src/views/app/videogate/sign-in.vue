  ...
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper pt-5" v-if="start"> 
        <router-link :to="edit?'':{name:'home'}">
          <img src="/videogate/images/prev.png" style="position:absolute;top:5%;left:5%;width:20px;">
          
        </router-link>
        <div class="header-logo" >
                        
                <img src="/videogate/images/logo.png" style="max-width:200px;max-height:80px;object-fit:contain;" >
        ...
        <div class="login-am" v-if="crnt_tab=='login'">
            ...
            <div id="signInBorder" class="signin-2">
              <div class="text-center">
                ...
                <h4 class=" text-13 my-4" style="line-height:20px;" @click="selectContent(blocks[1])" :class="blocks[1].is_edit?'selected_content':''" :id="'blocks_'+blocks[1].id" v-show="blocks[1].status">
                  {{blocks[1].value}}
                </h4>
              ...
              <form ref="loginUser" @submit.prevent="loginUser()">
                ...
                <div class="text-center mt-2 mb-4">
                    ...
                    <span><a  style="color: #d2ff00;">Forgot password?</a></span>
              ...
              <div class="d-flex justify-content-center my-4" style="gap:20px;">
                  <h6 class="text-10 text-white font-weight-600" style="width: 40px;
                    height: 40px;
                    border-radius: 50%;
                    display: flex;
                    align-items: center;
             ...
             <div class="d-flex justify-content-center my-3" style="gap:20px;">
                  <img src="/videogate/images/apple.svg" style="width:40px;">
                  <img src="/videogate/images/google.svg" style="width:40px;">
                  <img src="/videogate/images/fb.svg" style="width:40px;">
                  <img src="/videogate/images/twitter.svg" style="width:40px;">
                </div>
                
              <div class="text-center my-3">
                <span class="text-13 text-white mx-1">New to capcee?</span>
                <span class="text-13 cursor-pointer mx-1" style="color: #d2ff00;" @click="crnt_tab='register'">Register</span>
            ...
            <div id="signInBorder" class="signin-2">
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <div class="text-center  my-3">
                    ...
                    <span class="text-13 text-white">By proceeding you agree to our <a  style="color: #d2ff00;">Terms of service & privacy policy </a></span>
              ...
              <div class=" my-3" >
                  ...
                  <button  class=" w-100 d-flex align-items-center justify-content-center" style="border-radius:6px;background-color:white;color:#000;">
                    <img src="/videogate/images/google.svg" style="width:45px;height:45px;"> 
                    Sign in
                  </button>
              ...
              <div class="text-center my-3">
                ...
                <span class="text-13 cursor-pointer mx-1" style="color: #d2ff00;" @click="crnt_tab='login'">Login</span>
