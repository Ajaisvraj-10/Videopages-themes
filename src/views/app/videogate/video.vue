            ...
            <div class="row position-relative" style="margin-top:80px;" v-if="current_movie.id && start">
                <div class="col-md-12 position-relative">
                    ...
                    <div class="cursor-pointer" v-else>
                        <img :src="api_url+current_movie.thumbnail"  class="banner-vid w-100 thumb_img" @click="playMovie()"><div class="overlay-in-video px-lg-5 px-4">
                       
                        <div class="video-controls mb-2">
                            <div class="w-100">
                                <div class="" style="position: relative;z-index: 999;max-width:360px;">
                                ...
                                <div class="reverse-680">
                                    ...
                                    <div class="flex-align3 modal-icons-2 play-buttons">
                                        <div class="btn btn-outline-secondary text-white   mr-3 " >
                                            
                                            <h4 class="font-weight-500 text-16">Play</h4>
                                        </div>
                                        ...
                                        <div class=" text-white mr-3 "  >
                                            <h4 class="font-weight-500 text-16"> Watchlist</h4>
                                        </div>
                                ...
                                <div class="stars my-3" >
                                    <div class="flex-align3 my-1" v-for="movie_spec in current_movie.specs">
                                        <h6 class="text-13 text-white font-weight-300 pr-2" style="min-width:150px;">{{movie_spec.label}}</h6>

                                        <h6 class="text-13 font-weight-300 pr-2" style="min-width:150px;">: {{movie_spec.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-3">
                                        <h6 class="text-13 text-white font-weight-300 pr-2" style="min-width:150px;">Genres</h6>

                                        <h6 class="text-13 font-weight-300 pr-2" style="min-width:150px;">: {{current_movie.category_detail.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-3">
                                        <h6 class="text-13 text-white font-weight-300 pr-2" style="min-width:150px;">Language</h6>

                                        <h6 class="text-13 font-weight-300 pr-2" style="min-width:150px;">: {{current_movie.language_detail.name}}</h6>
                                    </div>
