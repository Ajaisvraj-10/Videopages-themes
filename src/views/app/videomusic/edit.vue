  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='videomusic'">
...
<script>
import SignInPage from '/src/views/app/videomusic/sign-in'
import HomePage from '/src/views/app/videomusic/home'
import PlanPage from '/src/views/app/videomusic/plan'
import VideosPage from '/src/views/app/videomusic/movies'
import WatchingPage from '/src/views/app/videomusic/video'
export default {
  components: {
    SignInPage,
    HomePage,
