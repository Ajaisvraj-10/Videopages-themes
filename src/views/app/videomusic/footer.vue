        ...
        <footer class="footer py-md-4 px-md-5 px-2 py-4" >
            <div class="flex-align" style="flex-wrap: wrap;gap:20px;">
                <div class="flex-align3" style="gap:10px;">
                    ...
                    <a :href="site_footer.playstore_link" target="_blank" v-show="site_footer.is_playstore" class="d-flex"><img src="/videomusic/images/play_store.png"></a>
                    <a :href="site_footer.appstore_link" target="_blank" v-show="site_footer.is_appstore" class="d-flex"><img src="/videomusic/images/app_store.png"></a>
