              ...
              <b-tabs pills card vertical>
                <b-tab title="My Profile" active>
                  <div class="profile-tab" v-if="view_profile">
                    <div class="pb-2 tabs-heading">
                      <h4 class="font-weight-400">My Profile</h4>
                    </div>
                    <div class="flex-align3 py-4" style="gap:15px;">
                      <h6 class="profile-pic text-dark">{{profile.username?profile.username[0]:''}}</h6>
                      <div class="profile-head">
                        <h5 class="text-20 font-weight-400">{{profile.username}}</h5>
                  ...
                  <div class="profile-editing-tab"  v-else>
                    <div class="pb-2 tabs-heading">
                      <h4 class="font-weight-400">Edit Profile</h4>
                    </div>
                ...
                <b-tab title="My Watchlist" @click="userWatch()">
                  <div class="pb-2 tabs-heading">
                    <h4 class="font-weight-400">My Watchlist</h4>
                  </div>
                                      ...
                                      <div class="position-relative" >
                                          ...
                                          <div class="hover-modal-div">
                                              ...
                                              <div class="small-details">
                                                  <h5 class="text-14 font-weight-400 mt-1 text-dark2">{{watch.movie_detail.name}}</h5>
                                                  <h5 class="text-10 font-weight-400 mt-1 text-dark"><span class=" pr-2"></span>{{dateFormate(watch.created_on)}}</h5>
                                              </div>
                                          </div>
                                      </div>
                                  </router-link>
                ...
                <b-tab title="My Subcription" @click="mySubscription()">
                  <div class="pb-2 tabs-heading">
                    <h4 class="font-weight-400">My Subscription</h4>
                  </div>
                  <div class="profile-tab">
                ...
                <b-tab title="My Rentals" @click="myRents()">
                  <div class="pb-2 tabs-heading">
                    <h4 class="font-weight-400">My Rentals</h4>
                  </div>
                  <div class="profile-tab">
                    <table class="table table-striped">
                        <tr class="">
                ...
                <b-tab title="My Transactions" @click="myTransactions()">
                  <div class="pb-2 tabs-heading">
                    <h4 class="font-weight-400">My Transactions</h4>
                  </div>
                  <div class="profile-tab">
                    <table class="table table-striped">
                        <tr class="">
...
.profile-body .nav-pills .nav-link {
    ...
    white-space: nowrap;
     border-right: .5px solid #484848!important;
