  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 text-center">
        <div class="mt-0" style="position:relative;width:320px;height:680px" v-if="themename=='videomusic_app'">
...
<script>
import SignInPage from '/src/views/app/videomusic_app/sign-in'
import HomePage from '/src/views/app/videomusic_app/home'
import PlanPage from '/src/views/app/videomusic_app/plan'
import VideosPage from '/src/views/app/videomusic_app/movies'
import WatchingPage from '/src/views/app/videomusic_app/video'
export default {
  components: {
    SignInPage,
    HomePage,
