    ...
    <div class="site-wrapper"> 
      ...
      <div class="plan-container">
        <!--<div class="plan-banners mb-4">
          <img src="/videomusic_app/images/bg1.jpg">
        </div>-->
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          ...
          <div class="plan-card row mx-0">
            ...
            <div class="col-md-12 plan-card-col" >
              <div class="plans-card" v-for="plan in plans" :style="plan.id==current_plan.id?'background: #1a2224;':''" @click="current_plan=plan">
                <div class="px-3 pt-2 rounded2-top position-relative" >
                  ...
                  <div class="flex-align">
                    ...
                    <span class="text-white text-20 font-weight-400 ">{{plan.currency_symbol}}{{plan.price}}</span>
                  
                  </div>
                </div>
                <div class="rounded2-bottom px-3 pb-3  text-white text-14 font-weight-500" >
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                ...
                <img src="/videomusic_app/images/google.svg" style="width:40px;">
                <img src="/videomusic_app/images/fb.svg" style="width:40px;">
                <img src="/videomusic_app/images/twitter.svg" style="width:40px;">
              </div>
