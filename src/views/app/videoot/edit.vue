  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='videoot'">
...
<script>
import SignInPage from '/src/views/app/videoot/sign-in'
import HomePage from '/src/views/app/videoot/home'
import PlanPage from '/src/views/app/videoot/plan'
import VideosPage from '/src/views/app/videoot/movies'
import WatchingPage from '/src/views/app/videoot/video'
export default {
  components: {
    SignInPage,
    HomePage,
