...
<template>
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper"> 
        ...
        <div class="px-3 py-2 w-100 sign-in-header" >             
        ...
        <div class="sign-in-body">
          <img src="/videoot/images/logo.png" class="mx-auto d-flex mt-4" style="max-width:200px;max-height:80px;object-fit:contain;">
          <div class="login-am" v-if="crnt_tab=='login'">
                
              <div id="signInBorder" class="signin-2">
                <div class="text-center">
                  
                  <h4 class=" text-22 mt-4 font-weight-500" style="line-height:20px;" @click="selectContent(blocks[1])" :class="blocks[1].is_edit?'selected_content':''" :id="'blocks_'+blocks[1].id" v-show="blocks[1].status">
                    {{blocks[1].value}}
                  </h4>
                  <div class="my-4">
                    <form ref="loginUser" @submit.prevent="loginUser()">
                      ...
                      <div class="text-center my-3">
                        ...
                        <span class="text-13  mx-1 cursor-pointer" style="color: #a785ff;" @click="crnt_tab='register'">Register</span>
                  ...
                  <div class="d-flex justify-content-center my-3" style="gap:15px;">
                    <img src="/videoot/images/apple.svg" style="width:50px;">
                    <img src="/videoot/images/google.svg" style="width:50px;">
                    <img src="/videoot/images/fb.svg" style="width:50px;">
                    <img src="/videoot/images/twitter.svg" style="width:50px;">
                  </div>
                </div>
              ...
              <div id="signInBorder" class="signin-2 mt-5">
                ...
                <form ref="registerUser" @submit.prevent="registerUser()">
                  ...
                  <div class="text-center  my-3">
                      ...
                      <span class="text-13 text-white">By proceeding you agree to our <a  style="color: #a785ff;">Terms of service & privacy policy </a></span>
                ...
                <div class="text-center my-3">
                  ...
                  <span class="text-13 cursor-pointer mx-1" style="color: #a785ff;" @click="crnt_tab='login'">Login</span>
...
.capcee-login input{
  border:none;
  border-bottom: 2px solid #a785ff!important;
...
.sign-in-header{
  max-height: 100px;
    height: 100%;
    background: url(/videoot/images/bg5.jpg);
    background-size: cover;
}
.sign-in-body{
  background: linear-gradient(360deg, #1a0c3c, #390e78);
  width: 100%;
  max-width:460px;
    height: auto;
    
    margin: 20px;
    box-shadow: 0 -6px 3px 1px #662eb6;
}
::placeholder{
  color:white;
}
