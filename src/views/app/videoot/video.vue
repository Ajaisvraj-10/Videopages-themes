                        ...
                        <div class="video-controls mb-2">
                            <div class="w-100">
                                ...
                                <div class="reverse-680">
                                    ...
                                    <div class="flex-align3 modal-icons-2 mb-4  play-buttons">
                                ...
                                <div class="stars my-3" style="opacity:.6;">
                                    <div class="flex-align3 my-1" v-for="movie_spec in current_movie.specs">
                                        ...
                                        <h6 class="text-16 font-weight-600 pr-2" style="color:#29d4b6;min-width:150px;">: {{movie_spec.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-3">
                                        <h6 class="text-16 text-white font-weight-600 pr-2" style="min-width:150px;">Genres</h6>

                                        <h6 class="text-16 font-weight-600 pr-2" style="color:#29d4b6;min-width:150px;">: {{current_movie.category_detail.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-3">
                                        <h6 class="text-16 text-white font-weight-600 pr-2" style="min-width:150px;">Language</h6>

                                        <h6 class="text-16 font-weight-600 pr-2" style="color:#29d4b6;min-width:150px;">: {{current_movie.language_detail.name}}</h6>
                                    </div>
