  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='videopage'">
...
<script>
import SignInPage from '/src/views/app/videopage/sign-in'
import HomePage from '/src/views/app/videopage/home'
import PlanPage from '/src/views/app/videopage/plan'
import VideosPage from '/src/views/app/videopage/movies'
import WatchingPage from '/src/views/app/videopage/video'
export default {
  components: {
    SignInPage,
    HomePage,
