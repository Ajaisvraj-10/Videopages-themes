        ...
        <footer class="footer py-md-4 px-md-5 py-4 px-2" >
            <div class="flex-align" style="flex-wrap:wrap;gap:20px;">
                <div class="flex-align3" style="gap:10px;">
                    ...
                    <a :href="site_footer.playstore_link" target="_blank" v-show="site_footer.is_playstore"><img src="/videopage/images/play_store.png"></a>
                    <a :href="site_footer.appstore_link" target="_blank" v-show="site_footer.is_appstore"><img src="/videopage/images/app_store.png"></a>
