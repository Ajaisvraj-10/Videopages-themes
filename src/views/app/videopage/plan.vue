  ...
  <div class="main-content capcee-plan">
    ...
    <div class="site-wrapper"> 
        ...
        <div class="plan-container">
            ...
            <div class="plan-card row mx-0">
              ...
              <div class="col-md-12 plan-card-col pt-0">
                <div class="plan-scroll">
                  <div class="mb-3 " style="border: 1px solid gray;border-radius: 6px;position: relative;" v-for="plan in plans" v-if="plan.status" :style="plan.id==current_plan.id?'background:#000; ':'background: #111112;'" @click="current_plan=plan">
                    <div class="p-3 rounded cursor-pointer" >
                      ...
                      <div class="d-flex align-items-center justify-content-between ">
                        <div >
                          <div class="text-white font-weight-600  text-14" style="white-space:nowrap;">
                        ...
                        <div class="d-flex" >
                          <div class="text-14">
                             <!-- <sup class="text-dark ">₹999</sup> --><span class="text-white text-20 ml-3 font-weight-600 ">{{plan.currency_symbol}}{{plan.price}}</span>
                          </div>
                          ...
                          <template v-else>
                            <i class="ml-2 bg-light flex-align2 rounded-circle text-white" style="width:22px;height:22px;cursor:pointer"></i>
                          </template>
                        </div>
                      </div>
                    </div>
                    <div class="rounded2-bottom px-3 py-2  text-14 font-weight-500" style="border-radius:0 0 6px 6px;">
                      {{plan.description}}
          ...
          <footer class="footer footer-capc py-md-4 py-3 px-md-5 px-2" >
            <div class="flex-align" style="gap:20px;flex-wrap:wrap;">
                <div class="flex-align3" style="gap:10px;">
                    <h6 class="text-14">Download Apps</h6>
                    <img src="/videopage/images/play_store.png">
                    <img src="/videopage/images/app_store.png">
