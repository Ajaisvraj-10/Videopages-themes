        ...
        <div class="login-am" v-if="crnt_tab=='login'">
            ...
            <div id="signInBorder" class="signin-2">
              ...
              <div class="d-flex justify-content-center my-3" style="gap:20px;">
                  <img src="/videopage/images/apple.svg" style="width:40px;">
                  <img src="/videopage/images/google.svg" style="width:40px;">
                  <img src="/videopage/images/fb.svg" style="width:40px;">
                  <img src="/videopage/images/twitter.svg" style="width:40px;">
                </div>-->
        ...
        <div class="signin-am" v-if="crnt_tab=='register'">
            <div id="signInBorder" class="signin-2">
              ...
              <div class=" my-3" >
                  ...
                  <button  class=" w-100 d-flex align-items-center justify-content-center" style="border:1px solid #fff;cursor:pointer;border-radius:35px;background-color:initial;color:#fff;height:44px;">
...
.capcee-login .site-wrapper {
      background:linear-gradient(45deg, #000000b0, #000000a1), url(/videopage/images/bg1.jpg);
       height:100vh;
       overflow:auto;
