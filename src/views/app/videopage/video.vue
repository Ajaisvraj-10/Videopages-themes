...
<template>
  <div class="main-content main-content-2 video-page" :class="mode=='light'?'mode_change':''">
        ...
        <div class="site-wrapper2" :class="menu_click?'nav-active':''">
            ...
            <div class="row position-relative" style="margin-top:50px;background-color: black;" v-if="current_movie.id && start">
                <div class="col-lg-8">
                ...
                <div class="overlay-in-video col-lg-4 px-lg-4 px-4">
                            ...
                            <div class="w-100">
                                ...
                                <div class="stars my-3" style="opacity:.6;">
                                    <div class="flex-align3 my-1" v-for="movie_spec in current_movie.specs">
                                        ...
                                        <h6 class="text-16 font-weight-600 pr-2" style="min-width:150px;">: {{movie_spec.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-3">
                                        <h6 class="text-16 text-white font-weight-600 pr-2" style="min-width:150px;">Genres</h6>

                                        <h6 class="text-16 font-weight-600 pr-2" style="min-width:150px;">: {{current_movie.category_detail.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-3">
                                        <h6 class="text-16 text-white font-weight-600 pr-2" style="min-width:150px;">Language</h6>

                                        <h6 class="text-16 font-weight-600 pr-2" style="min-width:150px;">: {{current_movie.language_detail.name}}</h6>
                                    </div>
                                    <div class="flex-align3 modal-icons-2 my-4  play-buttons">
                                        <div class="share  text-white border-right flex-align3  pr-3 mr-3" >
                                            
                                            <h4 class="font-weight-500 text-16">Share</h4>
                                        </div>
                                        
                                        <div class="share  text-white flex-align3  pr-3 mr-3" >
