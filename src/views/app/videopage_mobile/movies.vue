  ...
  <div class="main-content main-content-2" :class="mode=='light'?'mode_change':''">
        ...
        <div class="site-wrapper2" :class="menu_click?'nav-active':''">
            ...
            <footer class="footer py-4 px-3" >
                    <div class="flex-align" style="flex-wrap: wrap;gap: 30px">
                        ...
                        <div class="flex-align3 social2" >
                            ...
                            <a v-for="social_link in social_links" :href="social_link.link" target="_blank"><i :class="social_link.icon"></i></a>
                                    ...
                                    <div class="text-center my-3">
                                        <img src="/videopage_mobile/images/logo.png"  class="logo" style="width:100px!important;">
                                        ...
                                        <h6 class="text-13 text-light p-2">© 1996-2022, videopage_mobile.com, Inc. or its affiliates </h6>
                                    </div>
            </footer>
        </div>
  </div>
