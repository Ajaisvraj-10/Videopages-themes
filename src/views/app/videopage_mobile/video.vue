...
<template>
  <div class="main-content main-content-2" :class="mode=='light'?'mode_change':''">
    ...
    <div class="site-wrapper2 video-wrapper" :class="menu_click?'nav-active':''">   
            ...
            <div v-if="current_movie.id && start" style="margin-top:90px;">
                <div class="video-tab position-relative" v-if="current_movie.message=='play'">
                    ...
                    <div class="caps-play"><i class="fa fa-play mr-2"></i> Watch Movie</div>
                </div>
                <div class="video-tab position-relative" v-else>
                ...
                <!--<div class="flex-align plan-banner" v-if="!frontent_settings.have_plan">
                    <h6 class="text-12">Ad-Free with Premium now at 30%OFF:$699/year</h6> 
                    <router-link :to="edit?'':{name:'plan'}">
                        <button class="btn" style="background-color: #8230c6;color: white;font-size: 13px;font-weight: 500;border: 1px solid #8230c6;border-radius: 5px;padding:8px 10px;width: max-content;">
                        <img src="/videopage_mobile/images/king.png" style="width:16px;" class="mr-1">BUY PLAN</button>
                    </router-link>
                        
                </div>-->
                <div class="video-detail-icons flex-align" style="gap:15px;">
                    <div class="flex-align3" style="gap:25px;">
                        <div class="text-center">
                            <i class="fa fa-share text-white pb-1"></i>
                            <h6 class="text-10 text-white">Share</h6>
                        </div>
                        <div class="text-center">
                            <i class="fa fa-list text-white pb-1"></i>
                            <h6 class="text-10 text-white">Watchlist</h6>
                        </div>
                        <div class="text-center ">
                            <i class="fa fa-download text-white pb-1"></i>
                            <h6 class="text-10 text-white">Download</h6>
                        </div>
                    </div>
                    <div class="text-center">
                            <i class="fa fa-video-camera text-white pb-1"></i>
                            <h6 class="text-10 text-white">Watch Trailer</h6>
                    </div>
                </div>
                <div style="background-color: #1b1c21;border-radius: 40px 40px 0 0;padding: 10px;">
                    <div class="video-details">
                        <div>
                            <img :src="current_movie.mobile_thumbnail?api_url+current_movie.mobile_thumbnail:api_url+current_movie.thumbnail"  class="rounded  thumb_img" @click="playMovie()" width="100px">
                        </div>
                        <div>
            ...
            <div class="second-section main-page-sec " style="background-color: #1b1c21;" v-if="current_movie.id && start">
