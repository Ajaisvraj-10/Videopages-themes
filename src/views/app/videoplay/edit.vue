  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='videoplay'">
...
<script>
import SignInPage from '/src/views/app/videoplay/sign-in'
import HomePage from '/src/views/app/videoplay/home'
import PlanPage from '/src/views/app/videoplay/plan'
import VideosPage from '/src/views/app/videoplay/movies'
import WatchingPage from '/src/views/app/videoplay/video'
export default {
  components: {
    SignInPage,
    HomePage,
