  ...
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper pt-5" v-if="start"> 
        <router-link :to="edit?'':{name:'home'}">
          <img src="/videoplay/images/prev.png" class="back-btn">
        </router-link>
        <div class=" text-center mx-auto" >
                <router-link to="/">
                    <img src="/videoplay/images/logo.png" class="" style="max-width:340px;max-height:80px;">
                </router-link>             
        </div>
            ...
            <div id="signInBorder" class="signin-2">
              ...
              <form ref="loginUser" @submit.prevent="loginUser()">
                <label>
                  ...
                  <input type="email" name="email" placeholder="Emailo ID or Mobile Number" value="" required>
                </label>
                <br>
                <label>
              ...
              <div class="text-center my-3">
                <span class="text-13  mx-1 login-opt" style="color:lightgray;">New to capcee?</span>
                <span class="text-13 cursor-pointer mx-1 login-opt font-weight-800" style="color: white;" @click="crnt_tab='register'">Register</span>
        ...
        <!--<div class="otp-am" v-if="crnt_tab=='otp'">
            ...
            <div id="signInBorder" class="signin-2">
                <div class="mb-3">
                  ...
                  <h6 class="text-white fontweight-400  text-13 login-opt">
            ...
            <div id="signInBorder" class="signin-2">
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <div class="text-right  mt-1 mb-4">
                    ...
                    <span class="text-13 login-opt" style="color:lightgray;">By proceeding you agree to our <a  style="color: #fff;font-weight-800">Terms of service & privacy policy </a></span>
              ...
              <div class="text-center my-3">
                <span class="text-13 text-white mx-1 login-opt" style="color:lightgray;">Already registered?</span>
                <span class="text-13 cursor-pointer mx-1 font-weight-800 login-opt" style="color: #fff;" @click="crnt_tab='login'">Login</span>
             ...
             <!-- <div class="d-flex justify-content-center my-4" style="gap:20px;">
              ...
              <div class=" my-3" >
                  ...
                  <button  class=" w-100 d-flex align-items-center justify-content-center" style="border-radius:6px;background-color:white;color:#e91e63;">
                    <img src="/videoplay/images/google.svg" style="width:45px;heoght:45px;"> 
                    Sign in
                  </button>
...
.capcee-login input:focus{
  ...
  box-shadow: 0px 0px 1.5px 1.5px #f44336;
  outline:0;
}

.capcee-login input:-internal-autofill-selected {
