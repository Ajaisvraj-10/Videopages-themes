  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='videoplayer'">
...
<script>
import SignInPage from '/src/views/app/videoplayer/sign-in'
import HomePage from '/src/views/app/videoplayer/home'
import PlanPage from '/src/views/app/videoplayer/plan'
import VideosPage from '/src/views/app/videoplayer/movies'
import WatchingPage from '/src/views/app/videoplayer/video'
export default {
  components: {
    SignInPage,
    HomePage,
