...
<template>
    <div>
        <footer class="footer  px-2 py-3 px-lg-5 py-lg-4" >
            <div class="flex-align" style="flex-wrap:wrap;gap:20px;">
                <div class="flex-align3" style="gap:10px;">
                    <h6 class="text-14">Download Apps</h6>
                    <a :href="site_footer.playstore_link" target="_blank" v-show="site_footer.is_playstore"><img src="/videoplayer/images/play_store.png"></a>
                    <a :href="site_footer.appstore_link" target="_blank" v-show="site_footer.is_appstore"><img src="/videoplayer/images/app_store.png"></a>
            ...
            <div class="text-center mb-3">
                <img :src="frontent_settings.main_logo" class="logo mt-4"  style="max-height:80px;max-width:160px!important;" v-show="site_footer.is_logo">
