  ...
  <div class="main-content capcee-plan">
    ...
    <div class="site-wrapper"> 
        <header class="header-holder-2" >             
                <div class="menu-wrapper  d-flex align-items-center justify-content-between" style="background:initial;min-height:50px;background-color: #35322e;"> 
                    <div class="flex-align3">         
                        
                            <router-link to="/">
                                <img src="/videoplayer/images/nav_left.png" style="width:16px;">
                            </router-link>               
        ...
        <div class="plan-container">
          ...
          <div class="plan-sec " v-if="crnt_tab=='plans'">
            <h6 class="plan-head">Anytime Big Entertainment</h6>
            ...
            <div class="plan-card row mx-0">
              ...
              <div class="col-lg-6 plan-card-col">
                <div class="mb-3 rounded" v-for="plan in plans" v-if="plan.status" :style="plan.id==current_plan.id?'background: rgba(206,163,70,.3);':'background: initial;'" @click="current_plan=plan">
          ...
          <footer class="footer p-3" >
                    <div class="flex-align" style="flex-wrap: wrap; gap: 25px;">
                        <div class="flex-align3" style="gap:10px;">
                            ...
                            <img src="/videoplayer_app/images/play_store.png">
                            <img src="/videoplayer_app/images/app_store.png">
...
.capcee-plan .btn-primary{
     border-color: #c89d40;
    background: linear-gradient(96deg,#c89d40,#ffd476 100%);
}
...
.plan-card .plan-card-col:first-child{
  background:linear-gradient(219deg, #20190b, #392e16, #20190a);
  border-radius:10px;
