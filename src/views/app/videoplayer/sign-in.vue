...
<template>
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper pt-4" v-if="start"> 
        <router-link :to="edit?'':{name:'home'}">
          <img src="/videoplayer/images/nav_left.png" style="width:16px;" class="mb-4">
        </router-link>
        <div class="login-am" v-if="crnt_tab=='login'">
              
            <div id="signInBorder" class="signin-2">
              <div class="text-center">
                <p class="mb-3 text-24 font-weight-500" >
                  LOGIN
                </p>
                <h4 class=" text-16 font-weight-500 mb-4" style="line-height:20px;" @click="selectContent(blocks[1])" :class="blocks[1].is_edit?'selected_content':''" :id="'blocks_'+blocks[1].id" v-show="blocks[1].status">
                  {{blocks[1].value}}
                </h4>
              ...
              <form ref="loginUser" @submit.prevent="loginUser()">
                ...
                <div class="text-center mt-3 mb-5">
                    ...
                    <span><a  style="color: #2689a5;">Forgot password?</a></span>
              ...
              <div class="text-center my-3">
                ...
                <span class="text-13 cursor-pointer mx-1" style="color: #2689a5;" @click="crnt_tab='register'">Register</span>
                ...
                <div class="d-flex justify-content-center my-4" style="gap:20px;">
                 ...
                 <div class="d-flex row justify-content-center my-3 mx-0" style="flex-wrap: wrap;">
                  <div class="col-md-6 col-12 p-1">
                    <div class="rounded text-12 py-2 px-3 font-weight-500 flex-align2" style="gap:10px;border:0.5px solid #464646">
                      <img src="/videoplayer/images/google.svg" style="width:30px;">
                      Continue with google
                    </div>
                  </div>
                  <div class="col-md-6 col-12 p-1">
                    <div class="rounded text-12 py-2 px-3 font-weight-500 flex-align2" style="gap:10px;border:0.5px solid #464646">
                      <img src="/videoplayer/images/fb.svg" style="width:30px;">
            ...
            <div id="signInBorder" class="signin-2">
              ...
              <form ref="registerUser" @submit.prevent="registerUser()">
                ...
                <div class="text-center  my-3">
                    ...
                    <span class="text-13 text-white">By proceeding you agree to our <a  style="color: #2689a5;">Terms of service & privacy policy </a></span>
              ...
              <div class="text-center my-3">
                ...
                <span class="text-13 cursor-pointer mx-1" style="color: #2689a5;" @click="crnt_tab='login'">Login</span>
                ...
                <div class=" my-3" >
                  ...
                  <button  class="text-20 w-100 d-flex align-items-center justify-content-center" style="border-radius:6px;background-color:white;color:#2689a5;font-weight:700;">
                    <img src="/videoplayer/images/google.svg" style="width:50px;height:50px;"> 
                    Sign in
                  </button>
...
.capcee-login .site-wrapper {
     background: linear-gradient(148deg, rgba(0,0,0,0.47) 8%, rgba(18,18,18,0.82) 73%);
       height:100vh;
       overflow:auto;
