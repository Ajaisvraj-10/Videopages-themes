...
<template>
  <div class="main-content main-content-2" :class="$root.mode=='light'?'mode_change':''">
        ...
        <div class="site-wrapper2" :class="menu_click?'nav-active':''">
            ...
            <div class="close-movies my-4 mx-2" style="width:20px;">
                        <router-link to="/">
                            <img src="/videoplayer/images/close.png" style="width:20px;">
                        </router-link>
            </div>
                        ...
                        <div class="video-controls mb-5">
                            <div class="w-100">
                                <div class="w-50 " style="position: relative;z-index: 999;">
                                    ...
                                    <div class="ratings flex-align3 my-3" style="opacity:.5;">
                                        <div class="flex-align3 mr-2">
                                            <span class="text-10 border font-weight-400 rounded mr-2" style="padding:2px 3px;">IMDB</span>
                                            <h6 class="font-weight-200 text-15 mr-2">{{current_movie.message}}</h6>
                                        </div>
                                        <div class="flex-align3 mr-2">
                                            
                                            <h6 class="font-weight-200 text-15 mr-2">2 h 38 min</h6>
                                            <h6 class="font-weight-200 text-15 mr-2">2022</h6>
                                        </div>
                                ...
                                <div class="reverse-680">
                                    <div class='w-50'>
                                        <h4 class="text-14 my-3 font-weight-200 text-white main-heading-2" style="line-height:20px;">{{current_movie.description}}</h4>
                                    </div>
                                    <!--<div class="reverse-680"><div class="flex-align3 modal-icons-2 play-buttons">
                                        <div class="share text-32 text-white flex-align3 py-2 px-4 rounded mr-3 button-control" style="min-height:55px;">
                                            ...
                                            <h4 class="font-weight-500 text-22">Play</h4>
                                        </div>
                                ...
                                <div class="stars my-3" style="opacity:.9;">
                                    <div class="flex-align3 my-1" v-for="movie_spec in current_movie.specs">
                                        <h6 class="text-16 text-white font-weight-200 pr-2" style="min-width:150px;">{{movie_spec.label}}</h6>

                                        <h6 class="text-16 font-weight-200 pr-2" style="color:#0f79af;min-width:150px;">: {{movie_spec.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-3">
                                        <h6 class="text-16 text-white font-weight-200 pr-2" style="min-width:150px;">Genres</h6>

                                        <h6 class="text-16 font-weight-200 pr-2" style="color:#0f79af;min-width:150px;">: {{current_movie.category_detail.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-3">
                                        <h6 class="text-16 text-white font-weight-200 pr-2" style="min-width:150px;">Language</h6>

                                        <h6 class="text-16 font-weight-200 pr-2" style="color:#0f79af;min-width:150px;">: {{current_movie.language_detail.name}}</h6>
                                    </div>
                                ...
                                <template #img>
                                    <div class="image-row">
                                        ...
                                        <div class="hover-modal image"v-for="movie in sort_movie" @click="current_movie=movie">
                                            ...
                                            <div class="position-relative slider-sec " >
                                                ...
                                                <div class="hover-modal-div">
                                                   ...
                                                   <div class="small-details ">
                                                           ...
                                                           <div class="flex-align mb-2">
                                                                <button class="btn btn-info flex-align3 py-1 px-2">
                                                                    <i class="fa fa-play mr-1 " style="font-size:8px;"></i>
                                                                    <h5 class=" font-weight-500" style="font-size:8px;">Play</h5>
                                                                </button>
                                                                <button class="btn flex-align3 py-1 px-2" >
                                                                    <i class="fa fa-share-alt  text-dark mr-1" style="font-size:8px;"></i>
                                                                    <h5 class=" text-dark font-weight-500" style="font-size:8px;">Share</h5>
                                                                </button>
                                                            ...
                                                            <h5 class="text-10 font-weight-500 mt-1 text-white2">{{movie.name}}</h5>

                                                            <!--<h5 class="text-10 font-weight-500 mt-1 text-white">{{movie.description}}</h5>-->

                                                            <h5 class="font-weight-400 mt-1 text-white" style="font-size:8px;"><span class=" pr-2">98% match</span><span class=" pr-2">2022</span>2h 30m</h5>
                    ...
                    <div class="plan-card2 row mx-0">
                      <div class="col-md-12 plan-card-col">
                        ...
                        <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                          <img src="/videoplayer/images/apple.svg" style="width:40px;">
                          <img src="/videoplayer/images/google.svg" style="width:40px;">
                          <img src="/videoplayer/images/fb.svg" style="width:40px;">
                          <img src="/videoplayer/images/twitter.svg" style="width:40px;">
                        </div>
...
<script>
import MainHeader from '/src/views/app/videoplayer/header'
import MainFooter from '/src/views/app/videoplayer/footer'
export default {
