  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        <div class="mt-0" style="position:relative" v-if="themename=='videostar'">
...
<script>
import SignInPage from '/src/views/app/videostar/sign-in'
import HomePage from '/src/views/app/videostar/home'
import PlanPage from '/src/views/app/videostar/plan'
import VideosPage from '/src/views/app/videostar/movies'
import WatchingPage from '/src/views/app/videostar/video'
export default {
  components: {
    SignInPage,
    HomePage,
