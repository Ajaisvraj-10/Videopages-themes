  ...
  <div class="main-content capcee-plan">
    ...
    <div class="site-wrapper"> 
        ...
        <header class="header-holder-2" >             
                <div class="menu-wrapper  d-flex align-items-center justify-content-between" style="background:initial;min-height:60px;"> 
              ...
              <div class="col-md-12 plan-card-col">
                ...
                <div class="row mt-4">
                  <div class="col-md-4 col-6">
                    <div class="prize-card active-prize-card">
                      <h6>Super</h6>
                      <h5><sup>₹</sup>899/Year</h5>
                    </div>
                  </div>
                  <div class="col-md-4 col-6">
                    <div class="prize-card ">
                      <h6>Premium</h6>
                      <h5><sup>₹</sup>1499/Year</h5>
                    </div>
                  </div>
                  <div class="col-md-4 col-6">
                    <div class="prize-card ">
                      <h6>Premium</h6>
                      <h5><sup>₹</sup>299/Month</h5>
                    </div>
                  </div>
                </div>

                <button class="btn btn-primary w-100 text-dark rounded2 mt-5 py-2" v-if="current_plan.id" @click="getPaymentMethods();crnt_tab='payment_methods'">Continue with {{current_plan.currency_symbol}}{{current_plan.price}}</button>
          ...
          <footer class="footer footer-capc py-4 px-md-5 px-2" >
            <div class="flex-align" style="flex-wrap: wrap;gap: 20px;">
                <div class="flex-align3" style="gap:10px;">
                    ...
                    <img src="/videostar/images/play_store.png">
                    <img src="/videostar/images/app_store.png">
...
<style>
  ...
  background:url(/videostar/images/bg2.jpg);
  position: absolute;
    width: 100%;
    height: 100%;
...
.plan-container:after {
    content: '';
    position: absolute;
    background: linear-gradient(360deg, #0d0620, #0000008f), url(/videostar/images/bg4.jpg);
    background-repeat: no-repeat;
    background-size: cover;
    width: 100%;
    height: 45vh;
...
.prize-card.active-prize-card{
  background: rgba(31,128,224,0.4);
    border: 1px solid #1f80e0;
}
.prize-card.active-prize-card:after{
  content:'✓';
  position:absolute;
  right:5px;
  top:-10px;
