            ...
            <div class="row position-relative" style="margin-top:80px;" v-if="current_movie.id && start">
                <div class="col-md-12">
                    ...
                    <div class="cursor-pointer" v-else>
                        <img :src="api_url+current_movie.thumbnail"  class="rounded banner-vid w-100 thumb_img" @click="playMovie()">
                    </div>
                        ...
                        <div class="video-controls mb-2">
                            <div class="w-100">
                                ...
                                <div class="reverse-680">
                                    <div class='w-50'>
                                        <h4 class="text-14 my-2 font-weight-400 text-white main-heading-2" style="line-height:20px;">{{current_movie.description}}</h4>
                                    </div>
                                    <div class="flex-align3 modal-icons-2 play-buttons">
                                        
                                        
                                        <div class="text-20 bg-info text-white flex-align3 py-2 px-3 rounded button-control"  style="">
                                             <i class="fa fa-play mr-2"></i>
                                            <h4 class="font-weight-500 text-16"> Watch Movie</h4>
                                        </div>
                                        <div class="share flex-align3 text-18 text-white py-2 rounded mx-3 text-center button-control" style="min-height:55px;">
                                            <i class="fa fa-share mr-2"></i>
                                            <h4 class="font-weight-500 text-16">Share</h4>
                                        </div>
                                        
                                    </div>
                                   
                                </div>
                                <div class="stars my-2" style="opacity:.6;">
                                    <div class="flex-align3 my-1" v-for="movie_spec in current_movie.specs">
                                        ...
                                        <h6 class="text-16 font-weight-600 pr-2" style="color:#fff;min-width:150px;">: {{movie_spec.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-2">
                                        <h6 class="text-16 text-white font-weight-600 pr-2" style="min-width:150px;">Genres</h6>

                                        <h6 class="text-16 font-weight-600 pr-2" style="color:#fff;min-width:150px;">: {{current_movie.category_detail.name}}</h6>
                                    </div>
                                    <div class="flex-align3 mb-2">
                                        <h6 class="text-16 text-white font-weight-600 pr-2" style="min-width:150px;">Language</h6>

                                        <h6 class="text-16 font-weight-600 pr-2" style="color:#fff;min-width:150px;">: {{current_movie.language_detail.name}}</h6>
                                    </div>
                                        ...
                                        <div class="hover-modal image"v-for="movie in sort_movie" @click="current_movie=movie">
                                            ...
                                            <div class="position-relative" >
                                                ...
                                                <div class="hover-modal-div">
                                                   ...
                                                   <div class="small-details px-2">
                                                            
                                                           

                                                            <h5 class="font-weight-600 mt-1 text-white2" style="font-size:8px;">{{movie.name}}</h5>

                                                            <!--<h5 class="text-10 font-weight-600 mt-1 text-white">{{movie.description}}</h5>-->

                                                            <h5 class=" font-weight-600 mt-1 text-white" style="font-size:7px;"><span class=" pr-2">98% match</span><span class=" pr-2">2022</span>2h 30m</h5>

                                                            <div class="flex-align3 mt-1">
                                                                <div class="rounded py-1 flex-align3 modal-icons" >
                                                                    <i class="fa fa-play  text-white " style="font-size:7px;"></i>
                                                                    <h5 class=" text-white font-weight-600" style="font-size:8px;">Watch Movie</h5>
                                                                </div>
                    ...
                    <div class="plan-card2 row mx-0">
                      <div class="col-md-12 plan-card-col">
                        ...
                        <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                          <img src="/videostar/images/apple.svg" style="width:40px;">
                          <img src="/videostar/images/google.svg" style="width:40px;">
                          <img src="/videostar/images/fb.svg" style="width:40px;">
                          <img src="/videostar/images/twitter.svg" style="width:40px;">
                        </div>
...
<script>
import MainHeader from '/src/views/app/videostar/header'
import MainFooter from '/src/views/app/videostar/footer'
export default {
...
<style scoped>
  @import '/videostar/style/style.css';
  @import '/videostar/style/style-2.css';
  .thumb_img:hover{
    opacity:0.5;
  }
</style>
