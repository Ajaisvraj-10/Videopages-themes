  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 text-center">
        <div class="mt-0" style="position:relative;width:320px;height:680px" v-if="themename=='videostar_mobile'">
...
<script>
import SignInPage from '/src/views/app/videostar_mobile/sign-in'
import HomePage from '/src/views/app/videostar_mobile/home'
import PlanPage from '/src/views/app/videostar_mobile/plan'
import VideosPage from '/src/views/app/videostar_mobile/movies'
import WatchingPage from '/src/views/app/videostar_mobile/video'
export default {
  components: {
    SignInPage,
    HomePage,
