    ...
    <div class="site-wrapper"> 
        ...
        <header class="header-holder-2" >             
                <div class="menu-wrapper  d-flex align-items-center justify-content-between" style="background:initial;"> 
                    <div class="flex-align3" style="gap:20px;">
                        <router-link to="/">
                          <img src="/videostar_mobile/images/prev.png" style="width:20px;">
                        </router-link>         
        ...
        <div class="plan-container">
          ...
          <footer class="footer footer-capc py-4 px-md-5 px-2" >
            <div class="flex-align2" style="flex-wrap: wrap;gap: 20px;">
...
.plan-container:after {
    content: '';
    position: absolute;
    background: linear-gradient(360deg, #0d0620, #0000008f), url(/videostar_mobile/images/bg4.jpg);
    background-repeat: no-repeat;
    background-size: cover;
    width: 100%;
    height: 45vh;
