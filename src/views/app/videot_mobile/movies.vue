                        ...
                        <div class="flex-align3 social2" >
                            ...
                            <a v-for="social_link in social_links" :href="social_link.link" target="_blank"><i :class="social_link.icon"></i></a>
                                    ...
                                    <div class="text-center mb-3">
                                        <img src="/videot_mobile/images/logo.png"  class="logo" style="width:100px!important;">
                                        ...
                                        <h6 class="text-13 text-light p-2">© 1996-2022, videot_mobile.com, Inc. or its affiliates </h6>
                                    </div>
            </footer>
        </div>
  </div>
