      ...
      <div class="plan-container">
        <div class="plan-sec px-3 " v-if="crnt_tab=='plans'">
          ...
          <div class="plan-card row mx-0">
            <div class="plan-icon">
              <img src="/videot_mobile_app/images/king2.png" >
            </div>
          ...
          <div class="plan-card2 row mx-0">
            <div class="col-md-12 plan-card-col">
              ...
              <div class="d-flex justify-content-center plans-social-icons my-3" style="gap:20px;">
                <img src="/videot_mobile_app/images/apple.svg" style="width:40px;">
                <img src="/videot_mobile_app/images/google.svg" style="width:40px;">
                <img src="/videot_mobile_app/images/fb.svg" style="width:40px;">
                <img src="/videot_mobile_app/images/twitter.svg" style="width:40px;">
              </div>
...
<style scoped>
  ...
  @import '/videot_mobile_app/style/style.css';
