  ...
  <div class="main-content capcee-login">
    ...
    <div class="site-wrapper"> 
        ...
        <div class="sign-in-body">
          <img src="/videot_mobile/images/logo.png" class="mx-auto d-flex mt-4" style="max-width:200px;max-height:80px;object-fit:contain;">
              ...
              <div id="signInBorder" class="signin-2">
                <div class="text-center">
                  ...
                  <div class="my-5">
                    <form ref="loginUser" @submit.prevent="loginUser()">
                      ...
                      <div class="text-center my-3">
                        ...
                        <span class="text-13  mx-1" style="color: #a785ff;" @click="crnt_tab='register'">Register</span>
                  ...
                  <div class="d-flex justify-content-center my-3" style="gap:15px;">
                    <img src="/videot_mobile/images/apple.svg" style="width:50px;">
                    <img src="/videot_mobile/images/google.svg" style="width:50px;">
                    <img src="/videot_mobile/images/fb.svg" style="width:50px;">
                    <img src="/videot_mobile/images/twitter.svg" style="width:50px;">
                  </div>
                </div>
...
.sign-in-header{
  max-height: 170px;
    height: 100%;
    background: url(/videot_mobile/images/bg5.jpg);
...
.sign-in-body{
  ...
  width: 100%;
    ...
    margin-top:-20px;
    box-shadow: 0 1px 3px 5px #662eb6;
}
::placeholder{
  color:white;
}
.main-content.capcee-login {
    max-width: 600px;
    margin: 0 auto;
}
</style>
