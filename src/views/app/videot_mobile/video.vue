...
<template>
  <div class="main-content main-content-2" :class="mode=='light'?'mode_change':''">
    ...
    <div class="site-wrapper2 video-wrapper" :class="menu_click?'nav-active':''">   
            ...
            <div class="p-3 w-100 flex-align3" style=" width:100%;" >    
                <router-link :to="edit?'':{name:'home'}">
                  <i class="fa fa-angle-left" style="font-size:26px;color:white;position:absolute;left:10px;top:10px;"></i>
                </router-link>
                <h5 class="text-14 font-weight-700 mb-0 text-center w-100">{{current_movie.name}} ({{current_movie.language_detail.name}})</h5>
            </div>
            <div v-if="current_movie.id && start">
                ...
                <!--<div class="flex-align plan-banner" v-if="!frontent_settings.have_plan">
                    ...
                    <router-link :to="edit?'':{name:'plan'}">
                        <button class="btn" style="background-color: #29d4b6;color: black;font-size: 12px;font-weight: 500;border: 1px solid #29d4b6;border-radius: 3px;padding:4px 10px;">
                        BUY PLAN</button>
                    </router-link>
                ...
                <div class="video-details">
                    ...
                    <h6 class="text-12 my-2"> {{current_movie.language_detail.name}}
                    </h6>
                    <h6 class="text-12 my-2">{{current_movie.description}}</h6>

                    <div class="" v-for="movie_spec in current_movie.specs">
                ...
                <div class="video-detail-icons" >
                    <div class=" row m-0">
                        <div class="col-12 p-2">
                            <div class="text-center flex-align2 bg-info  py-3 rounded">
                                <i class="fa fa-play pb-1"></i>
                                <h6 class="text-12 ml-3">Wacth Now</h6>
                            </div>
                        </div>
                        <div class="col-6 p-2">
                            <div class="text-center  bg-secondary  py-3 rounded">
