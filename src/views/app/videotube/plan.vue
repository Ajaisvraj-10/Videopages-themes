              ...
              <div class="sidebar">
                ...
                <div class="sidebar__categories">
                    ...
                    <div class="sidebar-tab" :class="$root.header_active=='subscription'?'active-nav':''" @click="$root.header_active='subscription'">
                      ...
                      <div class="sidebar__category px-0" >
              ...
              <div class="videos pt-5">
                <div class="row mx-0">
                  <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 ">
                    <div class="plan-card">
                      <div class="border px-3 py-4">
                        <h5 class="text-28 flex-align2 font-weight-600">Standard</h5>
                      </div>
                      <h5 class="my-2" style="line-height:20px;">Enjoy a free month of VideoTube Premium</h5>
                      <h6 class="my-2 font-weight-400" style="color:gray;">Get ad-free access, downloads, and background play when you get VideoTube Premium</h6>
                      <div class="my-3" style="display:flex;justify-content:flex-end;">
                        <h6 class="" style="color:#065fd4;">Subscribe</h6>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 ">
                    <div class="plan-card">
                      <div class="border px-3 py-4">
                        <h5 class="text-28 flex-align2 font-weight-600">Premium</h5>
                      </div>
                      <h5 class="my-2" style="line-height:20px;">Enjoy a free month of VideoTube Premium</h5>
                      <h6 class="my-2 font-weight-400" style="color:gray;">Get ad-free access, downloads, and background play when you get VideoTube Premium</h6>
                      <div class="my-3" style="display:flex;justify-content:flex-end;">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 ">
                    <div class="plan-card">
                      <div class="border px-3 py-4">
                        <h5 class="text-28 flex-align2 font-weight-600">Gold</h5>
                      </div>
                      <h5 class="my-2" style="line-height:20px;">Enjoy a free month of VideoTube Premium</h5>
                      <h6 class="my-2 font-weight-400" style="color:gray;">Get ad-free access, downloads, and background play when you get VideoTube Premium</h6>
                      <div class="my-3" style="display:flex;justify-content:flex-end;">
