  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        ...
        <div class="mt-0" style="position:relative" v-if="themename=='videozone_prime'">
          <HomePageVideozone edit="1" :blocks="blocks" class="combonent_class" v-if="current_page.slug=='/'" @selectedContent="selectedContent"></HomePageVideozone>
          <SignInPageVideozone edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/sign-in'" @selectedContent="selectedContent"></SignInPageVideozone>
          <PlanPageVideozone edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/plan'" @selectedContent="selectedContent"></PlanPageVideozone>
          <MainPageVideozone edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/main'" @selectedContent="selectedContent"></MainPageVideozone>
          <WatchingPageVideozone edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/watching'" @selectedContent="selectedContent"></WatchingPageVideozone>
        </div>
      </div>
...
import SignInPageVideozone from '/src/views/app/videozone_app/sign-in'
import HomePageVideozone from '/src/views/app/videozone_app/home'
import PlanPageVideozone from '/src/views/app/videozone_app/plan'
import MainPageVideozone from '/src/views/app/videozone_app/main'
import WatchingPageVideozone from '/src/views/app/videozone_app/video'
export default {
  components: {
    SignInPageVideozone,
    HomePageVideozone,
    MainPageVideozone,
    WatchingPageVideozone,
  },
  data() {
    return {
      page_id:null,
