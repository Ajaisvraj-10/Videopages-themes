  ...
  <div>
    ...
    overflow: hidden;">
      ...
      <div class="col-lg-8 px-0 ">
        ...
        <div class="mt-0" style="position:relative" v-if="themename=='videozone_web'">
          <HomePagevideozone_web edit="1" :blocks="blocks" class="combonent_class" v-if="current_page.slug=='/'" @selectedContent="selectedContent"></HomePagevideozone_web>
          <SignInPagevideozone_web edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/sign-in'" @selectedContent="selectedContent"></SignInPagevideozone_web>
          <PlanPagevideozone_web edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/plan'" @selectedContent="selectedContent"></PlanPagevideozone_web>
          <MainPagevideozone_web edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/main'" @selectedContent="selectedContent"></MainPagevideozone_web>
          <WatchingPagevideozone_web edit="1" :blocks="blocks" class="combonent_class" v-else-if="current_page.slug=='/watching'" @selectedContent="selectedContent"></WatchingPagevideozone_web>
        </div>
      </div>
...
import SignInPagevideozone_web from '/src/views/app/videozone_web/sign-in'
import HomePagevideozone_web from '/src/views/app/videozone_web/home'
import PlanPagevideozone_web from '/src/views/app/videozone_web/plan'
import MainPagevideozone_web from '/src/views/app/videozone_web/main'
import WatchingPagevideozone_web from '/src/views/app/videozone_web/video'
export default {
  components: {
    SignInPagevideozone_web,
    HomePagevideozone_web,
    MainPagevideozone_web,
    WatchingPagevideozone_web,
  },
  data() {
    return {
      page_id:null,
