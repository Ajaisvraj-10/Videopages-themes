                                                ...
                                                <div class="position-relative" >
                                                    ...
                                                    <div class="hover-modal-div">
                                                       ...
                                                       <div class="small-details">
                                                            ...
                                                            <h5 class="text-16 font-weight-500 mt-1 ext-white">{{movie.name}}</h5>

                                                           

                                                            <h5 class="text-14 font-weight-400 mt-1 text-light"><span class=" pr-2">98% match</span><span class=" pr-2">2022</span>2h 30m</h5>
