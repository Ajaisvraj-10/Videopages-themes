                ...
                <div class="row">
                    <div class="col-2" v-for="movie in movies">
                        <div class="image-row" >
                            ...
                            <div class="hover-modal image m-0" >
                                    ...
                                    <div class="position-relative" >
                                        ...
                                        <div class="hover-modal-div">
                                            ...
                                            <div class="small-details">
                                                <h5 class="text-14  mt-1">{{movie.name}}</h5>
                                                <h5 class="text-10  mt-1"><span class=" pr-2">98% match</span><span class=" pr-2">2022</span>2h 30m</h5>
