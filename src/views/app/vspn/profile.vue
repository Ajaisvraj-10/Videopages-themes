              ...
              <b-tabs pills card vertical>
                <b-tab title="My Profile" active>
                  <div class="profile-tab" v-if="view_profile">
                    <div class="pb-4 tabs-heading flex-align">
                  ...
                  <div class="profile-tab">
                     <div class="row">
                        <div class="col-2" v-for="watch in user_watchs">
                            <div class="image-row" >
                              <div class="hover-modal image mx-0" >
                                      ...
                                      <div class="position-relative" >
                                          ...
                                          <div class="hover-modal-div">
                                              ...
                                              <div class="small-details">
                                                  <h5 class="text-14  mt-1">{{watch.movie_detail.name}}</h5>
                                                  <h5 class="text-10  mt-1 ">{{dateFormate(watch.created_on)}}</h5>
                                              </div>
                                          </div>
                                      </div>
                                  </router-link>
